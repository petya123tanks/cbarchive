			...
			function library:New(name)
				...
				Menu.Size = UDim2.new(0, 600, 0, 740)
				Menu.Image = "rbxassetid://7856811676"
			...
			function keybindadd(text)
				...
				TextLabel.Size = UDim2.new(0, txt:GetTextSize(name, 15, Enum.Font.Code, Vector2.new(700, TextLabel.AbsoluteSize.Y)).X, 0, 29)
				TextLabel.Font = Enum.Font.Code
				TextLabel.Text = name
				TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
				TextLabel.TextSize = 14.000
				...
				TabButtons.Position = UDim2.new(TextLabel.Size.X.Scale, TextLabel.Size.X.Offset+275, 0, 0)
				...
				function menu:Tab(text)
					...
					TextButton.TextColor3 = Color3.fromRGB(49, 49, 49)
					...
					TabGui.Name = "TabGui"
					TabGui.Parent = Tabs
					TabGui.BackgroundColor3 = Color3.fromRGB(150, 0, 0)
						...
						if currenttab ~= text then
							for i,v in pairs(TabButtons:GetChildren()) do
								if v:IsA("TextButton") then
									library:Tween(v, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(49, 49, 49)})
								end
							end
					...
					function Tab:MSector(text, side)
						...
						Section.BorderColor3 = Color3.fromRGB(22, 22, 22)
						...
						SectionText.TextStrokeTransparency = 0.590

						Inner.Name = "Inner"
						Inner.Parent = Section
						Inner.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
						Inner.BorderColor3 = Color3.fromRGB(22, 22, 22)
						...
						function MSector:Tab(text)
							...
							tab1.Name = text
							tab1.Parent = Inner
							tab1.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
							tab1.BorderColor3 = Color3.fromRGB(22, 22, 22)
							...
							TextButton.Size = UDim2.new(0, txt:GetTextSize(text, 14, Enum.Font.Code, Vector2.new(700,700)).X + 2, 1, 0)
							TextButton.Font = Enum.Font.Code
							TextButton.Text = text
							...
							function tab:Element(type, text, data, callback)
								...
								elseif type == "ToggleKeybind" then
									...
									local function update()
										if Element.value.Toggle then
											tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(30, 146, 110)})
											library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
										else
											keybindremove(text)
									...
									do
										...
										Keybind.Size = UDim2.new(0,txt:GetTextSize("none", 14, Enum.Font.Code, Vector2.new(700, 12)).X + 5,0, 12)
										...
										Always.Name = "Always"
										Always.Parent = Frame
										Always.BackgroundColor3 = Color3.fromRGB(30,30,30)
										...
										Hold.Name = "Hold"
										Hold.Parent = Frame
										Hold.BackgroundColor3 = Color3.fromRGB(30,30,30)
										...
										Keybind.MouseButton1Down:Connect(function()
											if not binding then
												...
												binding = true
												Keybind.Text = "..."
												Keybind.Size = UDim2.new(0,txt:GetTextSize("...", 14, Enum.Font.Code, Vector2.new(700, 12)).X + 4,0, 12)
											end
										end)
										...
										game:GetService("UserInputService").InputBegan:Connect(function(input)
											...
											if binding then
												...
												Keybind.Size = UDim2.new(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.Code, Vector2.new(700, 12)).X + 5,0, 12)
												...
												if input.KeyCode.Name == "Backspace" then
													Keybind.Text = "none"
													Keybind.Size = UDim2.new(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.Code, Vector2.new(700, 12)).X + 4,0, 12)
								...
								elseif type == "Slider" then
									...
									UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 146, 110)), ColorSequenceKeypoint.new(1, Color3.fromRGB(9, 84, 59))}
						...
						function Sector:Element(type, text, data, callback)
							...
							elseif type == "TextBox" then
								...
								TextBox:GetPropertyChangedSignal("Text"):Connect(function()
									if string.len(TextBox.Text) > 1000 then
										TextBox.Text = string.sub(TextBox.Text, 1, 1000)
									end
			...
			local function UpdateAccessory(Accessory)
				...
				if values.visuals.effects["accessory material"].Dropdown ~= "ForceField" then
					Accessory.Mesh.TextureId = "111876444"
				else
			...
			local gui = library:New("Carbon.An")
			...
			getgenv().api = {}
			api.newtab = function(name, side)
				return gui:Tab(name, side)
			end
			...
			aimbot:Element("Jumbobox", "resolver", {options = {"pitch", 'testing'}})
			aimbot:Element("Toggle", "delay shot")
			aimbot:Element("Toggle", "force hit")
			aimbot:Element("Toggle", "Bads Prediction")
			aimbot:Element("Toggle", "teammates")
			aimbot:Element("Toggle", "auto baim")
			aimbot:Element('Slider', 'Knifebot Radius', {min = -100, max = 100, default = 20})
			...
			antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "zero", "180", "random", 'Down+'}})
			antiaim:Element("Toggle", "extend pitch")
			antiaim:Element("Dropdown", "body roll", {options = {"off", "180 treehouse"}})
			antiaim:Element("Slider", "spin speed", {min = 1, max = 48, default = 4})
			antiaim:Element("Toggle", "PositionYlevel")
			antiaim:Element("Slider", "PositionYlevel2", {min = -200, max = 200, default = 4})
			...
			fakelag:Element('Slider', 'Fakelagchams transparency', {min = 0, max = 1, default = 0.3})
				...
				if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and values.rage.fakelag.enabled.Toggle then
					if LagTick == (values.rage.fakelag.amount.Dropdown == "static" and values.rage.fakelag.limit.Slider or math.random(1, values.rage.fakelag.limit.Slider)) then
						...
						if values.rage.fakelag["visualize lag"].Toggle then
							local tranparency = values.rage.fakelag['Fakelagchams transparency'].Slider
			...
			effects:Element('Slider', 'F0v',  {min = 1, max = 180})
			effects:Element('Slider', 'size2',  {min = 1, max = 180})
effects:Element('Toggle', 'out of field of view arrows', {}, function(tbl)
	if tbl.Toggle then
		local Targets = {}
		local FieldOfView = values.visuals.effects['F0v'].Slider
		local Dynamic = true
		local Team = true
		local Size = values.visuals.effects['size2'].Slider
		local Color = Color3.fromRGB(123, 130, 207)
		...
		game:GetService("RunService").RenderStepped:connect(function()
		   for Name, Target in next, Targets do
			...
			effects:Element('ToggleColor', 'animated forcefield gun', {default = {Color = Color3.fromRGB(255,255,255)}}, {}, function(tbl)
				if tbl.Toggle then
				local ArmsColorsEnabled = true
        ...
        if ViewmodelFolder.Name == 'Arms' and ArmsColorsEnabled == true then
            for i,v in pairs(ViewmodelFolder:GetChildren()) do
                ...
                if v:IsA("BasePart") and v.Name ~= ("Right Arm" or "Left Arm" or "Flash") and v.Transparency~=1 then -- Weapons Pointer
                    ...
                    Weapons.Transparency = 0
                    Weapons.Reflectance = 0
                    if Weapons.TextureID then
                        Weapons.TextureID = "rbxassetid://111876444"
                    end
                    Weapons.Color = Color3.fromRGB(255,255,255)
...
ArmsColorsEnabled = false
			...
			world:Element("ToggleColor", "hit chams", {default = {Color = COL3RGB(0, 0, 255)}}, function(tbl)
			...
			world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "Semi", "neverlose"}})
			...
			client:Element("Toggle", "infinite cash", nil, function(tbl)
				if tbl.Toggle then
					LocalPlayer.Cash.Value = 99999999999
				end
			end)
...
Frame.Parent = ScreenGui
Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Frame.BorderColor3 = Color3.fromRGB(45, 101, 161)
Frame.BorderSizePixel = 2
Frame.Position = UDim2.new(0.779296637, 0, 0.115117878, 0)
Frame.Size = UDim2.new(0, 238, 0, 21)

TextLabel.Parent = Frame
TextLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.BackgroundTransparency = 1.000
TextLabel.Position = UDim2.new(0.367389083, 0, 0, 0)
TextLabel.Size = UDim2.new(0, 56, 0, 21)
...
TextLabel_2.Position = UDim2.new(0.552263021, 0, 0, 0)
TextLabel_2.Size = UDim2.new(0, 105, 0, 21)
...
TextLabel_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_3.BackgroundTransparency = 1.000
TextLabel_3.Position = UDim2.new(0.0714285746, 0, 0, 0)
TextLabel_3.Size = UDim2.new(0, 59, 0, 20)
TextLabel_3.Font = Enum.Font.Ubuntu
TextLabel_3.Text = "Carbon.An     I"
TextLabel_3.TextColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_3.TextSize = 14.000

-- Scripts:

local function JNPA_fake_script() -- TextLabel.LocalScript 
...
coroutine.wrap(JNPA_fake_script)()
local function VQBI_fake_script() -- TextLabel_2.LocalScript 
	local script = Instance.new('LocalScript', TextLabel_2)

	script.Parent.Text = 'I   '..game.Players.LocalPlayer.Name
end
coroutine.wrap(VQBI_fake_script)()
local function ZOCHWFR_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(ZOCHWFR_fake_script)()
else
	game.CoreGui.ScreenGui:Destroy()
			...
			movement:Element("ToggleKeybind", "freezeclip") --srry guys cant have freeze clip but u can have knife range
			...
			chat:Element("Toggle", "chat spam", nil, function(tbl)
				if tbl.Toggle then
					while values.misc.chat["chat spam"].Toggle do
						game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "buy aristois.me", false, "Innocent", false, true)
						wait(values.misc.chat["speed (ms)"].Slider/1000)
					end
				end
			end)
			chat:Element("Dropdown", "type", {options = {"standard", "aristois"}})
			...
			animations:Element("Dropdown", "animation", {options = {"floss", "default", "lil nas x", "dolphin", "monkey"}}, function(tbl)
				Dance.AnimationId = tbl.Dropdown == "floss" and "rbxassetid://5917459365" or tbl.Dropdown == "default" and "rbxassetid://3732699835" or tbl.Dropdown == "lil nas x" and "rbxassetid://5937558680" or tbl.Dropdown == "dolphin" and "rbxassetid://5918726674" or tbl.Dropdown == "monkey" and "rbxassetid://3333499508"
				...
				if PlayerIsAlive then
					...
					if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then
						if values.rage.aimbot.enabled.Toggle then
							local Origin = values.rage.aimbot.origin.Dropdown == "character" and LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 9, 0) or CamCFrame.p
							...
							for _,Player in pairs(Players:GetPlayers()) do
								...
								if Player.Character and Player.Character:FindFirstChild("Humanoid") and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and Player ~= LocalPlayer then
									...
									if table.find(values.rage.aimbot.resolver.Jumbobox, "roll") then
										...
										if table.find(values.rage.aimbot.Jumbox, 'testing') then
										...
										if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then
											...
											for _,Hitbox in ipairs(Hitboxes) do
												...
												if values.rage.aimbot["automatic penetration"].Toggle then
													...
													until EndHit ~= nil or #Hits >= 3 or Hit == nil
													if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 3 then
														if #Hits == 0 then
															...
															for i = 1, #Hits do
																...
																local direction = (Hitbox.Position - pos).unit * math.clamp(Client.gun.Range.Value, 1, 1000)
					...
					if UserInputService:IsKeyDown("Space") and values.misc.movement["bunny hop"].Toggle then
						...
						BodyVelocity.Velocity = Vector3.new(rot.LookVector.X,3,rot.LookVector.Z) * (values.misc.movement["speed"].Slider * 2)
					...
					if values.rage.angles.enabled.Toggle and not DisableAA then
						...
						if values.rage.angles["PositionYlevel"].Toggle == true and PositionYlevel == false then
							LocalPlayer.Character.LowerTorso.Root.C0 = LocalPlayer.Character.LowerTorso.Root.C0 * CFrame.Angles(0, 0, 0) * CFrame.new(0, values.rage.angles["PositionYlevel2"].Slider, 0)
							PositionYlevel = true
						end

						local Pitch = values.rage.angles["pitch"].Dropdown == "none" and CamLook.Y or values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "zero" and math.huge or 10.10 or values.rage.angles["pitch"].Dropdown == "random" and math.random(-97, 68)/1 or -4 or values.rage.angles["pitch"].Dropdown == "Down+" and -129433
			...
			mt.__namecall = function(self, ...)
				...
				if method == "FireServer" and self.Name == "HitPart" then
					...
					if (values.rage.aimbot["Bads Prediction"].Toggle and  RageTarget ~= nil) then
						coroutine.wrap(function()
			...
			mt.__newindex = function(self, i, v)
				...
				if self:IsA("Humanoid") and i == "CameraOffset" then
					if values.rage.angles.enabled.Toggle and values.rage.angles["body roll"].Dropdown == "180" then
			...
			LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)
				...
				if values.misc.chat["kill say"].Toggle then
					game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "who.rru hhh nn laff uff ya b1g meme", false, "Innocent", false, true)
				end
			end)
			Camera.ChildAdded:Connect(function(obj)
				while true do
					...
					if table.find(values.misc.client["gun modifiers"].Jumbobox, "ammo") then
						Client.ammocount = 99999
						Client.ammocount2 = 99999
					end
				end
			end)
			Camera.ChildAdded:Connect(function(obj)
			...
			LocalPlayer.Cash:GetPropertyChangedSignal("Value"):Connect(function(cash)
				if values.misc.client["infinite cash"].Toggle and cash ~= 99999999999 then
					LocalPlayer.Cash.Value = 99999999999
				end
			end)
