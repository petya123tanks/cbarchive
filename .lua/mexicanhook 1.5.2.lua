...
local Crosshairs = game:GetService("Players").LocalPlayer.PlayerGui.Notifications.Crosshairs   
local Crosshair = game:GetService("Players").LocalPlayer.PlayerGui.Notifications.Crosshairs.Crosshair      
