	...
	library:CreateWatermark("Finity.cc | Build: BETA | Version: 0.2.9")
	...
	local cfglocation = "finitycfg/"      
	makefolder("finitycfg")      
	...
	makefolder("finitylua")      


	RunService.RenderStepped:Wait()      

	local gui = library:New("Finity.cc")      
	...
	chat:Element("Toggle", "chat spam", nil, function(tbl)      
		if tbl.Toggle then      
			while values.misc.chat["chat spam"].Toggle do      
				game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "Im using Finity.cc" or "Finity.cc > All! > https://discord.gg/EZkYtvJYa9", false, "Innocent", false, true)      
	...
	LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
		...
		if values.misc.chat["kill say"].Toggle then      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "1'd by Finity R.I.P" and values.misc.chat["message"].Text or "2 ez for Finity" and values.misc.chat["message"].Text or "beamed by Finity", false, "Innocent", false, true)      
		end      
	end)      
	...
	CreateHitElement("100% Loaded Finity.cc!",Color3.new(0,1,0))