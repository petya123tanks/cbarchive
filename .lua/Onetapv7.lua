print("Onetap Loading")
wait(0)
print("Loading")
wait(0)
print("Welcome to Onetap")

--Watermark totally isnt pasted
--this whole thing was pasted

getgenv().values = {}
local library = loadstring(game:HttpGet'https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua')()
library:CreateWatermark("Onetap | Users | V.7")
...
local gui = library:New("OnetapV7") 
