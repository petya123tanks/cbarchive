...
if not LPH_OBFUSCATED then
    ...
    LPH_JIT_MAX = function(a) return a end
    LPH_ENCSTR = function(a) return a end
end
...
local L_5_ = {
	...
	draggable = true,
	flags = {},
	title = "cuteware.fixed | by russianware | discord.gg/russianware",
	open = false,
...
function fireHitpart(L_1137_arg0, L_1138_arg1, L_1139_arg2, L_1140_arg3, L_1141_arg4)
	L_40_:FireServer(L_1137_arg0, L_1141_arg4 or encodePos(L_1137_arg0.Position), "SG", 4096, nil, nil, 999e99, false, true, Vector3.new(), -100, Vector3.new(0, 0, 0),  false, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
end;
function countESP()
	local L_1147_ = 0;
	...
	oldNamecall = hookmetamethod(game, "__namecall", LPH_NO_VIRTUALIZE(function(L_1236_arg0, ...)
		...
		if L_1238_ == "FireServzer" then
			...
			if L_1239_ == "HitPart" then
				local L_1255_, L_1256_, L_1257_, L_1258_, L_1259_, L_1260_, L_1261_, L_1262_, L_1263_, L_1264_, L_1265_, L_1266_, oh13, oh14, oh15, oh16, oh17, oh18, oh19, oh20, oh21, oh22, oh23, oh24, oh25 = ...
				L_1267_ = false;
				...
				if L_1219_["Movement Prediction"] and L_1219_["Ragebot"] and L_1271_ then
					...
					elseif L_1219_["Prediction Mode"] == "Adaptive" then
						coroutine.wrap(function()
                            local Velocity = (L_1255_.Character.HumanoidRootPart.Position - L_1255_.Character.HumanoidRootPart.Position) / 100
					...
					L_1254_ = false;
					oh13 = false;
					oldNamecall(L_1236_arg0, L_1255_, Vector3.new(L_1255_.Position.X, L_1255_.Position.Y, L_1255_.Position.Z) + Direction * ((Velocity.magnitude * (Ping / 1000) * (Ping > 200 and 1.5 or 2)) * Vector3.new(L_64_, L_65_, L_66_) + Vector3.new(L_61_, L_62_, L_63_)), L_1257_, L_1258_, L_1259_, L_1260_, L_1261_, L_1262_, L_1263_, L_1264_, L_1265_, L_1266_, oh13, oh14, oh15, oh16, oh17, oh18, oh19, oh20, oh21, oh22, oh23, oh24, oh25)
					spawn(function()
		...
		while library_flags["Knife Bot"] do
			...
			for L_1325_forvar0, L_1326_forvar1 in next, L_30_:GetPlayers() do
				if L_57_.alive and alive(L_1326_forvar1) and teamCheck(L_1326_forvar1, L_37_) and L_57_ and L_57_.melee and L_36_.gun and L_36_.gun:FindFirstChild("Melee") then
					...
					if L_1330_ <= 100 then
						fireHitpart(L_1326_forvar1.Character.HumanoidRootPart, 554321, true)
						wait(0.1)
					end
				end
			end
...
L_28_.RenderStepped:Connect(function(L_1691_arg0)
	...
	for L_1724_forvar0, L_1725_forvar1 in next, L_30_:GetPlayers() do
		...
		if library_flags["Kill All"] then
            local Ping = game.Stats.PerformanceStats.Ping:GetValue()
			for _,Player in pairs(L_30_:GetPlayers()) do
                if Player.Character and Player.Team ~= LocalPlayer.Team then
                    coroutine.wrap(function()
                        ...
                        local oh3 = "OLDSD"
                        local oh4 = -834795872368917
                        local oh5 = LocalPlayer.Character.Gun
                        local oh7 = 99e99
                        local oh8 = true
                        local oh9 = true
                        local oh10 = Vector3.new()
                        local oh11 = -78593416868
                        local oh12 = Vector3.new()
                        local oh13 = false
        
                        game:GetService("ReplicatedStorage").Events.HitPart:FireServer(oh1, oh2, oh3, oh4, oh5, nil, oh7, oh8, oh9, oh10, oh11, oh12, oh13, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
                    end)()
                end
            end
		end;
...
function fireHitpart(L_1145_arg0, L_1146_arg1, L_1147_arg2, L_1148_arg3, L_1149_arg4)
	L_40_:FireServer(L_1145_arg0, L_1149_arg4 or encodePos(L_1145_arg0.Position), "SG", -85934795637063, nil, nil, 999e99, false, true, Vector3.new(), -100, Vector3.new(0, 0, 0), false, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
end;
function countESP()
	local L_1155_ = 0;
	...
	oldNamecall = hookmetamethod(game, "__namecall", function(L_1244_arg0, ...)
		...
		if L_1246_ == "FireSzerver" then
			...
			if L_1247_ == "HitPart" then
				local L_1262_ = false;
				local L_1263_, L_1264_, L_1265_, L_1266_, L_1267_, L_1268_, L_1269_, L_1270_, L_1271_, L_1272_, L_1273_, oh13, oh14, oh15, oh16, oh17, oh18, oh19, oh20, oh21, oh22, oh23, oh24, oh25  = ...
				L_1275_ = false;
				...
				if L_1227_["Movement Prediction"] and L_1227_["Ragebot"] and L_1279_ then
					...
					elseif L_1227_["Prediction Mode"] == "Adaptive" then
						coroutine.wrap(function()
							local Velocity = (L_1263_.Character.HumanoidRootPart.Position - L_1263_.Character.HumanoidRootPart.Position) / 100
                           local Direction = Vector3.new(Velocity.X / Velocity.magnitude, 0, Velocity.Z / Velocity.magnitude)
						end)
					end;
					L_1266_ = 0;
					...
					L_1262_ = false;
					oh13 = true;
					oldNamecall(L_1244_arg0, L_1263_, Vector3.new(L_1263_.Position.X, L_1263_.Position.Y, L_1263_.Position.Z) + Direction * ((Velocity.magnitude * (Ping / 1000) * (Ping > 200 and 1.5 or 2)) * Vector3.new(L_64_, L_65_, L_66_) + Vector3.new(L_61_, L_62_, L_63_)), L_1265_, L_1266_, L_1267_, L_1268_, L_1269_, L_1270_, L_1271_, L_1272_, L_1273_, oh13, oh14, oh15, oh16, oh17, oh18, oh19, oh20, oh21, oh22, oh23, oh24, oh25)
					spawn(function()
		...
		while library_flags["Knife Bot"] do
			...
			for L_1333_forvar0, L_1334_forvar1 in next, L_30_:GetPlayers() do
				if L_57_.alive and alive(L_1334_forvar1) and teamCheck(L_1334_forvar1, L_37_) and L_57_ and L_57_.melee and L_36_.gun and L_36_.gun:FindFirstChild("Melee") then
					...
					if L_1338_ <= 100 then
						fireHitpart(L_1334_forvar1.Character.HumanoidRootPart, 51, true)
						wait(0.1)
					end
				end
			end
