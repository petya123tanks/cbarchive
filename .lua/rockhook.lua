...
local cfglocation = "itsaboutdrivecfg/"      
makefolder("itsaboutdrivecfg")      
...
local MainUIColor = COL3RGB(255, 128, 0)    
...
function library:New(name)      
	...
	cursor.ZIndex = 1000      
	cursor.ImageColor3 = COL3RGB(255,128,0)      
	...
	Menu.Image = "http://www.roblox.com/asset/?id=7519363593"      
			...
			function MSector:Tab(text)      
				...
				function tab:Element(type, text, data, callback)      
					...
					if type == "Jumbobox" then      
						...
						ImageLabel.Image = "http://www.roblox.com/asset/?id=7519363593"      
...
local Skyboxes = {      
	...
	["amogus"] = { 
		SkyboxBk = "rbxassetid://5850251189", 
		SkyboxDn = "rbxassetid://5850251189", 
		SkyboxFt = "rbxassetid://5850251189", 
		SkyboxLf = "rbxassetid://5850251189", 
		SkyboxRt = "rbxassetid://5850251189", 
		SkyboxUp = "rbxassetid://411367386",  
	},
	["minecraft"] = { 
		SkyboxBk = "rbxassetid://71664975", 
		SkyboxDn = "rbxassetid://71669494", 
		SkyboxFt = "rbxassetid://71665049", 
		SkyboxLf = "rbxassetid://71665682", 
		SkyboxRt = "rbxassetid://71665012", 
		SkyboxUp = "rbxassetid://71669447",  
	},
	["amogus2"] = { 
		SkyboxBk = "rbxassetid://5752463190", 
		SkyboxDn = "rbxassetid://5872485020", 
	...
	["amogus3"] = { 
		SkyboxBk = "rbxassetid://6313528622", 
		SkyboxDn = "rbxassetid://6313528622", 
		SkyboxFt = "rbxassetid://6313528622", 
		SkyboxLf = "rbxassetid://6313528622", 
		SkyboxRt = "rbxassetid://6313528622", 
		SkyboxUp = "rbxassetid://6313528622",  
	},
	["chroma"] = { 
		SkyboxBk = "rbxassetid://6406361943", 
		SkyboxDn = "rbxassetid://6406361943", 
		SkyboxFt = "rbxassetid://6406361943", 
		SkyboxLf = "rbxassetid://6406361943", 
		SkyboxRt = "rbxassetid://6406361943", 
		SkyboxUp = "rbxassetid://6406361943",  
	},
	["pink"] = { 
...
makefolder("westayhungerlua")      


RunService.RenderStepped:Wait()      

local gui = library:New("ROCKHOOK")      
local legit = gui:Tab("legit")      
local rage = gui:Tab("rage")      
local visuals = gui:Tab("visuals")      
local misc = gui:Tab("misc")    
local models = gui:Tab("models")      
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "sus","cod"}})      
world:Element("Slider", "sound volume", {min = 1, max = 5, default = 3})      
world:Element("Dropdown", "skybox", {options = {"none", "nebula", "vaporwave", "clouds", "amogus", "minecraft", "amogus2", "amogus3", "chroma", "pink", "minecraft2", "dababy"}}, function(tbl)      
...
configs:Element("Button", "Watermark", nil, function()

        -- Instances:

        local library = loadstring(game:HttpGet'https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua')()
	library:CreateWatermark("It's about drive it's about power We stay hungry, we devour")
...
chat:Element("Toggle", "chat spam", nil, function(tbl)      
	if tbl.Toggle then      
		while values.misc.chat["chat spam"].Toggle do      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "It's about drive it's about power We stay hungry, we devour Put in the work, put in the hours and take what's ours", false, "Innocent", false, true)      
			wait(values.misc.chat["speed (ms)"].Slider/1000)      
			      
		end      
	end      
end)      
chat:Element("Dropdown", "type", {options = {"standard", "rocky"}})      
...
grenades:Element("Button", "crash server", {}, function() 
	...
	while true do
        pcall(function()
            game:GetService("RunService").RenderStepped:Wait()
            for i = 1,100,1 do																																																																									-- Server Crasher exploit by property (Rock). mis hermanos solo usan SEXWARE
...
CreateHitElement("Loading POWER..",Color3.new(1,1,0))


local modelssector = models:Sector("models","Left")
modelssector:Element("",{},function()
	game.ReplicatedStorage.Events.FallDamage:FireServer(LocalPlayer.Character.Humanoid.Health-1)
end)
				local D19ForniteCardToggle = false

modelssector:Element("Toggle", "19$ fortnite card", nil, function()  
  if D19ForniteCardToggle == false then
    ...
    game:GetObjects('rbxassetid://6571605917')[1].Parent = Model59548
    ...
    game:GetObjects('rbxassetid://6571605917')[1].Parent = Model55609
    Model = game.ReplicatedStorage.Viewmodels.Model
    for _, Child in pairs(Model:GetChildren()) do
        Child.Parent = Model.Parent
    end
    Model:Destroy()
    wait()
    game.ReplicatedStorage.Viewmodels["v_19kard"].Name = "v_CT Knife"
    game.ReplicatedStorage.Viewmodels["v_19kard"].Name = "v_T Knife"
    D19ForniteCardToggle = true
  else
    ...
    Model2:Destroy()
    D19ForniteCardToggle = false
  end
end)

local SauToggle = false

modelssector:Element("Toggle", "Sausage", nil, function()  
  if SauToggle == false then
	game.ReplicatedStorage.Viewmodels["v_CT Knife"]:Destroy()
	game.ReplicatedStorage.Viewmodels["v_T Knife"]:Destroy()
	wait()
	local Model1 = Instance.new("Model", game.ReplicatedStorage.Viewmodels)
	game:GetObjects('rbxassetid://7161045678')[1].Parent = Model1
	Model = game.ReplicatedStorage.Viewmodels.Model
	for _, Child in pairs(Model:GetChildren()) do
		Child.Parent = Model.Parent
	end
	...
	Model:Destroy()
	wait()
	game.ReplicatedStorage.Viewmodels["v_sausage"].Name = "v_CT Knife"
	game.ReplicatedStorage.Viewmodels["v_sausage"].Name = "v_T Knife"
    SauToggle = true
	  end
end)

local netToggle = false

modelssector:Element("Toggle", "Netherite Sword", nil, function()  
  if netToggle == false then
	game.ReplicatedStorage.Viewmodels["v_CT Knife"]:Destroy()
	game.ReplicatedStorage.Viewmodels["v_T Knife"]:Destroy()
	wait()
	local Model1 = Instance.new("Model", game.ReplicatedStorage.Viewmodels)
							...
							if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then      
								...
								for _,Hitbox in ipairs(Hitboxes) do      
									...
									if values.rage.aimbot["automatic penetration"].Toggle then      
										...
										local Penetration = Client.gun.Penetration.Value * 0.5      
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "It's about drive", false, "Innocent", false, true)      
	end      
end)      
