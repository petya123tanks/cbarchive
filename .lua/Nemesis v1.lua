...
function library:New(name)
    ...
    cursor.ZIndex = 1000
    cursor.ImageColor3 = Color3.fromRGB(0, 94, 255)
    ...
    Menu.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
    ...
    do
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(0, 94, 255)
        TextLabel.Position = UDim2.new(0, 1, 0.300000012, 0)
        TextLabel.Size = UDim2.new(0, 155, 0, 24)
        TextLabel.ZIndex = 2
        TextLabel.Font = Enum.Font.SourceSansSemibold
        TextLabel.Text = "keybinds"
        TextLabel.TextColor3 = Color3.fromRGB(0, 94, 255)
        TextLabel.TextSize = 14.000

        Frame.Parent = TextLabel
        Frame.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
    ...
    TextLabel.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
    ...
    TextLabel.Size =
        UDim2.new(
        0,
        txt:GetTextSize(name, 15, Enum.Font.SourceSansSemibold, Vector2.new(700, TextLabel.AbsoluteSize.Y)).X,
        0,
        29
    )
    TextLabel.Font = Enum.Font.SourceSansSemibold
    ...
    TabButtons.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
    ...
    Tabs.Name = "Tabs"
    Tabs.Parent = Menu
    Tabs.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
    ...
    function menu:Tab(text)
        ...
        TextButton.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
        TextButton.BackgroundTransparency = 1
        TextButton.Size =
            UDim2.new(0, txt:GetTextSize(text, 15, Enum.Font.SourceSansSemibold, Vector2.new(700, 700)).X + 12, 1, 0)
        TextButton.Font = Enum.Font.SourceSansSemibold
        TextButton.Text = text
        TextButton.TextColor3 = Color3.fromRGB(0, 94, 255)
        ...
        TabGui.Name = "TabGui"
        TabGui.Parent = Tabs
        TabGui.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
        ...
        Left.Name = "Left"
        Left.Parent = TabGui
        Left.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
        ...
        Right.Name = "Right"
        Right.Parent = TabGui
        Right.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                    ...
                    for i, v in pairs(TabButtons:GetChildren()) do
                        if v:IsA("TextButton") then
                            library:Tween(
                                ...
                                {TextColor3 = Color3.fromRGB(0, 94, 255)}
                            )
                        end
                    end
        ...
        function Tab:MSector(text, side)
            ...
            SectionText.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
            ...
            SectionText.TextColor3 = Color3.fromRGB(0, 94, 255)
            ...
            sectiontabs.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
            ...
            function MSector:Tab(text)
                ...
                TextButton.Size =
                    UDim2.new(
                    0,
                    txt:GetTextSize(text, 14, Enum.Font.SourceSansSemibold, Vector2.new(700, 700)).X + 2,
                    1,
                    0
                )
                TextButton.Font = Enum.Font.SourceSansSemibold
                ...
                function tab:Element(type, text, data, callback)
                    ...
                    if type == "Jumbobox" then
                        ...
                        Dropdown.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        ImageLabel.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        TextLabel_3.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                    ...
                    elseif type == "ToggleKeybind" then
                        ...
                        Toggle.Name = "Toggle"
                        Toggle.Parent = tab1
                        Toggle.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        Toggle.BackgroundTransparency = 1.000
                        Toggle.Size = UDim2.new(1, 0, 0, 15)

                        Button.Name = "Button"
                        Button.Parent = Toggle
                        Button.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        do
                            ...
                            Keybind.Size =
                                UDim2.new(
                                0,
                                txt:GetTextSize("NONE", 14, Enum.Font.SourceSansSemibold, Vector2.new(700, 12)).X + 5,
                                0,
                                12
                            )
                    ...
                    elseif type == "ToggleColor" then
                        ...
                        Colorpick.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        ColorDrag.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        Huepick.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        Huedrag.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        ColorH =
                            (math.clamp(
                            Huedrag.AbsolutePosition.Y - Huepick.AbsolutePosition.Y,
                            0,
                        ...
                        local function updateColor()
                            local ColorX =
                                (math.clamp(mouse.X - Colorpick.AbsolutePosition.X, 0, Colorpick.AbsoluteSize.X) /
                                Colorpick.AbsoluteSize.X)
                            local ColorY =
                                (math.clamp(mouse.Y - Colorpick.AbsolutePosition.Y, 0, Colorpick.AbsoluteSize.Y) /
                                Colorpick.AbsoluteSize.Y)
                    ...
                    elseif type == "ToggleTrans" then
                        ...
                        Transpick.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        Transcolor.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        Transdrag.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                    ...
                    elseif type == "Dropdown" then
                        ...
                        Drop.AutomaticCanvasSize = "Y"
                        Drop.ZIndex = 5
                        Drop.ScrollBarImageColor3 = Color3.fromRGB(0, 94, 255)
                    ...
                    elseif type == "Slider" then
                        ...
                        Slider.Name = "Slider"
                        Slider.Parent = tab1
                        Slider.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        UIGradient.Color =
                            ColorSequence.new {
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(153, 153, 153)),
                        ...
                        Value.Name = "Value"
                        Value.Parent = Slider
                        Value.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                        ...
                        Button.MouseButton1Down:Connect(
                            function()
                                ...
                                moveconnection =
                                    ...
                                    function()
                                        Frame.Size =
                                            UDim2.new(0, math.clamp(mouse.X - Frame.AbsolutePosition.X, 0, 175), 0, 5)
                                        val =
                                            math.floor(
                                    ...
                                    function(Mouse)
                                        if Mouse.UserInputType == Enum.UserInputType.MouseButton1 then
                                            Frame.Size =
                                                UDim2.new(
                                                0,
                                                math.clamp(mouse.X - Frame.AbsolutePosition.X, 0, 175),
                                                0,
                                                5
                                            )
                                            val =
        ...
        function Tab:Sector(text, side)
            ...
            function Sector:Element(type, text, data, callback)
                ...
                if type == "ScrollDrop" then
                    ...
                    for i, v in ipairs(joe) do
                        do
                            ...
                            Scroll.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                            ...
                            function()
                                if not binding then
                                    ...
                                    Keybind.Size =
                                        UDim2.new(
                                        0,
                                        txt:GetTextSize("...", 14, Enum.Font.SourceSansSemibold, Vector2.new(700, 12)).X +
                                            4,
                                        0,
                                        12
                                    )
                ...
                elseif type == "ToggleColor" then
                    ...
                    ColorH =
                        (math.clamp(Huedrag.AbsolutePosition.Y - Huepick.AbsolutePosition.Y, 0, Huepick.AbsoluteSize.Y) /
                        Huepick.AbsoluteSize.Y)
                    ColorS =
                        1 -
                        (math.clamp(
                ...
                elseif type == "TextBox" then
                    ...
                    Box.Name = "Box"
                    Box.Parent = Inner
                    Box.BackgroundColor3 = Color3.fromRGB(0, 94, 255)
                    ...
                    TextBox.TextColor3 = Color3.fromRGB(0, 94, 255)
...
fakelag:Element(
    "ToggleColor",
    "visualize lag",
    {default = {Toggle = false, Color = Color3.fromRGB(255, 255, 255)}},
    function(tbl)
        if tbl.Toggle then
                ...
                if
                    LagTick ==
                        (values.rage.fakelag.amount.Dropdown == "static" and values.rage.fakelag.limit.Slider or
                            math.random(1, values.rage.fakelag.limit.Slider))
                 then
                    game:GetService("NetworkClient"):SetOutgoingKBPSLimit(9e9)
                    FakelagFolder:ClearAllChildren()
                    LagTick = 0
...
effects:Element(
    "ToggleTrans",
    "weapon chams",
    {default = {Color = Color3.fromRGB(255, 255, 255), Transparency = 0}},
    function(tbl)
...
self:Element(
    ...
    function(val)
        ...
        ) * CFrame.Angles(0, 0, values.visuals.self.roll.Slider / 50)
    end
)
self:Element(
    "Slider",
...
self:Element(
    "ToggleColor",
    "self chams",
    {default = {Color = Color3.fromRGB(0, 94, 255)}},
    function(tbl)
        if tbl.Toggle then
            for _, obj in pairs(SelfObj) do
                if obj.Parent ~= nil then
...
world:Element(
    "ToggleTrans",
    "molly radius",
    {default = {Color = Color3.fromRGB(255, 0, 0)}},
    function(tbl)
...
world:Element(
    "ToggleColor",
    "smoke radius",
    {default = {Color = Color3.fromRGB(0, 255, 0)}},
    function(tbl)
        ...
        for i, weapon in pairs(workspace.Debris:GetChildren()) do
            if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then
                weapon.BillboardGui.ImageLabel.Visible =
                    tbl.Toggle and table.find(values.visuals.world["types"].Jumbobox, "icon") and true or false
            end
        end
    end
)
world:Element(
    ...
    function(tbl)
        for i, weapon in pairs(workspace.Debris:GetChildren()) do
            if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then
                weapon.BillboardGui.ImageLabel.Visible =
                    values.visuals.world["item esp"].Toggle and table.find(tbl.Jumbobox, "icon") and true or false
...
client:Element("ToggleColor", "hitmarker", {default = {Color = Color3.fromRGB(0, 94, 255)}})
        ...
        if tbl.Toggle then
            while values.misc.chat["chat spam"].Toggle do
                game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                    values.misc.chat.type.Dropdown == "standard" and "hi" or "Get Good Get Nemesis",
                    false,
                    "Innocent",
                    false,
                    true
...
chat:Element("Dropdown", "type", {options = {"standard", "Nemesis"}})
...
animations:Element(
    "Dropdown",
    "animation",
    {options = {"floss", "default", "lil nas x", "dolphin", "monkey"}},
    function(tbl)
        Dance.AnimationId =
...
do
    function add(plr)
        local ImageLabel = Instance.new("ImageLabel")
        ImageLabel.BackgroundColor3 = Color3.fromRGB(420, 69, 96)
        ImageLabel.BackgroundTransparency = 1.000
...
workspace.Debris.ChildAdded:Connect(
    function(obj)
        if obj:IsA("BasePart") and Weapons:FindFirstChild(obj.Name) then
            ...
            ImageLabel.ScaleType = Enum.ScaleType.Fit
            ImageLabel.Visible =
                values.visuals.world["item esp"].Toggle and table.find(values.visuals.world["types"].Jumbobox, "icon") and
                true or
                false
...
local function GetWeaponRage(weapon)
    return table.find(weps.Pistol, weapon) and "pistol" or table.find(weps.Rifle, weapon) and "rifle" or
...
local function GetWeaponLegit(weapon)
    return table.find(weps2.Pistol, weapon) and "pistol" or table.find(weps2.Rifle, weapon) and "rifle" or
        table.find(weps2.SMG, weapon) and "smg" or
        table.find(weps2.Sniper, weapon) and "sniper" or
        "default"
end
        ...
        if PlayerIsAlive then
            ...
            if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then
                if values.rage.aimbot.enabled.Toggle then
                    local Origin =
                        ...
                        LocalPlayer.Character.LowerTorso.Position + Vector3.new(0, 2.5, 0) or
                        CamCFrame.p
                                            ...
                                            if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 4 then
                                                if #Hits == 0 then
                                                    ...
                                                    if Damage >= Stats["minimum damage"].Slider then
                                                        ...
                                                        if not values.rage.aimbot["silent aim"].Toggle then
                                                            Camera.CFrame =
                                                                CFrame.new(CamCFrame.Position, EndHit.Position)
                                                        end
                                                        Filter = true
                                                        if values.rage.aimbot["automatic fire"].Dropdown == "standard" then
                                                            Client.firebullet()
                                                            if
                                                                values.rage.exploits["double tap"].Toggle and
                                                                    values.rage.exploits["double tap"].Active
                                                             then
                                                                Client.firebullet()
                                                            end
                                                        elseif
                                                    ...
                                                    for i = 1, #Hits do
                                                        ...
                                                        local direction =
                                                            ...
                                                            math.clamp(Client.gun.Range.Value, 1, 100)
                ...
                elseif
                 ...
                 then
                    ...
                    if
                        not table.find(Stats.conditions.Jumbobox, "blind") or
            ...
            if UserInputService:IsKeyDown("Space") and values.misc.movement["bunny hop"].Toggle then
                ...
                BodyVelocity.Velocity =
                    Vector3.new(rot.LookVector.X, 0, rot.LookVector.Z) * (values.misc.movement["speed"].Slider * 2)
                if
                 ...
                 then
                    ...
                    if values.misc.movement.type.Dropdown == "cframe" then
                        ...
                        Root.CFrame =
                            Root.CFrame +
                            Vector3.new(rot.LookVector.X, 0, rot.LookVector.Z) * values.misc.movement["speed"].Slider /
                                50
                    end
                end
            end
            ...
            if values.rage.angles.enabled.Toggle and not DisableAA then
                ...
                if values.rage.angles["body roll"].Dropdown == "180" then
                    Root.CFrame =
                        Root.CFrame *
                        CFrame.Angles(values.rage.angles["body roll"].Dropdown == "180" and math.rad(180) or 0, 1, 0)
        ...
        for _, Player in pairs(Players:GetPlayers()) do
            ...
            if
             ...
             then
                ...
                local Size =
                    (Camera:WorldToViewportPoint(RootPosition - Vector3.new(0, 3, 0)).Y -
                    Camera:WorldToViewportPoint(RootPosition + Vector3.new(0, 2.6, 0)).Y) /
                    2

                local Drawings, Text =
                    table.find(values.visuals.players.outlines.Jumbobox, "drawings") ~= nil,
                    table.find(values.visuals.players.outlines.Jumbobox, "text") ~= nil
                ...
                if values.visuals.players.health.Toggle then
                    ...
                    tbl.Health.To =
                        ...
                        tbl.Health.From.X,
                        tbl.Health.From.Y -
                            (Player.Character.Humanoid.Health / Player.Character.Humanoid.MaxHealth) * tbl.Box.Size.Y
                    )
                    ...
                    if Drawings then
                        ...
                        tbl.HealthOutline.To =
                            Vector2.new(tbl.Health.From.X, (tbl.Health.From.Y - 1 * tbl.Box.Size.Y) - 1)
                ...
                if values.visuals.players.weapon.Toggle then
                    ...
                    tbl.Weapon.Position =
                        Vector2.new(tbl.Box.Size.X / 2 + tbl.Box.Position.X, tbl.Box.Size.Y + tbl.Box.Position.Y + 1)
...
mt.__namecall = function(self, ...)
    ...
    if method == "FireServer" then
        if string.len(self.Name) == 38 then
            return
        elseif
            self.Name == "FallDamage" and table.find(values.misc.client["damage bypass"].Jumbobox, "fall") or
        ...
        if not checkcaller() or Filter then
            ...
            if RageTarget ~= nil then
                ...
                if values.rage.aimbot["delay shot"].Toggle then
                    ...
                    args[1] =
                        Ray.new(Origin, (RageTarget.Position - Origin).unit * (RageTarget.Position - Origin).magnitude)
                end
            end
        end
    end
                    ...
                    if Players:GetPlayerFromCharacter(args[1].Parent) or args[1] == RageTarget then
                        if values.rage.aimbot["prediction"].Dropdown == "cframe" then
                            ...
                            if Velocity.magnitude >= 8 then
                                args[2] =
                                    args[2] +
                                    Direction * (Velocity.magnitude * (Ping / 1000) * (Ping > 200 and 1.5 or 2))
                                args[4] = 0
                                args[12] = args[12] - 500
                            end
                        end
        ...
        if values.misc.chat["kill say"].Toggle then
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(
                values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or
                    "looks like you don't have stormy.solutions",
                false,
                "Innocent",
                false,
                true
