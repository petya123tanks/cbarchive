--joe.tapped
game.StarterGui:SetCore("SendNotification",{Title = "Joe.Tapped",Text = "Loading",Duration = 5})
getgenv().values = {}  
local library = {} 
...
local cfglocation = "joe.tappedcfg/" 
makefolder("joe.tappedcfg") 
...
function library:New(name) 
	...
	local joetapped = INST("ScreenGui") 
	...
	joetapped.Name = "joe.tapped UwU" 
	joetapped.ResetOnSpawn = false 
	joetapped.ZIndexBehavior = "Global" 
	joetapped.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = joetapped 
	...
	but.Parent = joetapped 

	local cursor = INST("ImageLabel") 
	cursor.Name = "cursor" 
	cursor.Parent = joetapped 
	...
	game:GetService("RunService").RenderStepped:connect(function() 
		cursor.Visible = joetapped.Enabled 
		cursor.Position = UDim2.new(0,Mouse.X-3,0,Mouse.Y+1) 
	end) 

	Menu.Name = "Menu" 
	Menu.Parent = joetapped 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			joetapped.Enabled = not joetapped.Enabled 
			library.uiopen = joetapped.Enabled 
		end 
	end) 
	...
	TextLabel.Size = UDim2.new(0, txt:GetTextSize(name, 15, Enum.Font.SourceSansSemibold, Vec2(700, TextLabel.AbsoluteSize.Y)).X, 0, 29) 
	TextLabel.Font = Enum.Font.SourceSansSemibold 
	TextLabel.Text = name 
	...
	function menu:Tab(text) 
		...
		TextButton.Size = UDim2.new(0, txt:GetTextSize(text, 15, Enum.Font.SourceSansSemibold, Vec2(700,700)).X+12, 1, 0) 
		...
		function Tab:MSector(text, side) 
			...
			function MSector:Tab(text) 
				...
				TextButton.Size = UDim2.new(0, txt:GetTextSize(text, 14, Enum.Font.SourceSansSemibold, Vec2(700,700)).X + 2, 1, 0) 
				TextButton.Font = Enum.Font.SourceSansSemibold 
				TextButton.Text = text 
				TextButton.TextColor3 = COL3RGB(200, 200, 200) 
				...
				function tab:Element(type, text, data, callback) 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(25, 25, 25) 
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(113, 13, 255)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(25, 25, 25)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(200, 200, 200)}) 
							end 
							values[tabname][sectorname][tabtext][text] = Element.value 
							callback(Element.value) 
						...
						do 
							...
							Keybind.BackgroundColor3 = COL3RGB(25, 25, 25) 
							Keybind.BorderColor3 = COL3RGB(27, 27, 35) 
							Keybind.Position = UDim2.new(0, 270, 0.5, -6) 
							Keybind.Text = "NONE" 
							Keybind.Size = UDim2.new(0, 43, 0, 12) 
							Keybind.Size = UDim2.new(0,txt:GetTextSize("NONE", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 5,0, 12) 
							...
							Frame.BackgroundColor3 = COL3RGB(25, 25, 25) 
							...
							Always.Name = "Always" 
							Always.Parent = Frame 
							Always.BackgroundColor3 = COL3RGB(25, 25, 25) 
							...
							Hold.Name = "Hold" 
							Hold.Parent = Frame 
							Hold.BackgroundColor3 = COL3RGB(25, 25, 25) 
							...
							Toggle.Name = "Toggle" 
							Toggle.Parent = Frame 
							Toggle.BackgroundColor3 = COL3RGB(25, 25, 25) 
							Toggle.BackgroundTransparency = 1.000 
								...
								if button:IsA("TextButton") then 
									...
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(113,13,255)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
							...
							Keybind.MouseButton1Down:Connect(function() 
								if not binding then 
									...
									binding = true 
									Keybind.Text = "..." 
									Keybind.Size = UDim2.new(0,txt:GetTextSize("...", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 4,0, 12) 
								end 
							end) 
							...
							game:GetService("UserInputService").InputBegan:Connect(function(input) 
								...
								if binding then 
									...
									Keybind.Size = UDim2.new(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 5,0, 12) 
									...
									if input.KeyCode.Name == "Backspace" then 
										Keybind.Text = "NONE" 
										Keybind.Size = UDim2.new(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 4,0, 12) 
					...
					elseif type == "ToggleColor" then 
						tabsize = tabsize + UDim2.new(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or COL3RGB(113,13,255)} 
					...
					elseif type == "ToggleTrans" then 
						tabsize = tabsize + UDim2.new(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or COL3RGB(113,13,255), Transparency = data.default and data.default.Transparency or 0} 
					...
					elseif type == "Slider" then 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(133, 13, 255)), ColorSequenceKeypoint.new(1, COL3RGB(113,13,255))}
						...
						local val 
						Button.MouseButton1Down:Connect(function() 
							Frame.Size = UDim2.new(0, CLAMP(mouse.X - Frame.AbsolutePosition.X, 0, 175), 0, 5) 
				...
				if firs then 
					...
					selected = text 
					TextButton.TextColor3 = COL3RGB(113,13,255) 
					tab1.Visible = true 
					firs = false 
				end 
		...
		function Tab:Sector(text, side) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				elseif type == "TextBox" then 
					...
					TextBox.Parent = Box 
					TextBox.BackgroundColor3 = COL3RGB(25, 25, 25) 
...
local CrimwalkFolder = INST("Folder", workspace) 
CrimwalkFolder.Name = "Crimwalk" 
...
for _,lua in pairs(listfiles("joeLua")) do 
	local luaname = string.gsub(lua, "joeLua\\", "") 
	table.insert(allluas, luaname) 
end 

RunService.RenderStepped:Wait() 

local gui = library:New("joe.tapped") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("joeLua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
...
aimbot:Element("Dropdown", "origin", {options = {"real character", "character", "camera"}}) 
aimbot:Element("Toggle", "auto shoot")
aimbot:Element("Slider", "ragebot multiplier", {min = 1, max = 100, default = 1})
aimbot:Element("Toggle", "resolver") 
aimbot:Element("Toggle", "prediction") 
aimbot:Element("Slider", "minimum damage", {min = -100, max = 100, default = 1}) 
...
antiaim:Element("Dropdown", "special yaw base", {options = {"none","custom","under","cursed","invis"}}) 
antiaim:Element("Slider", "cursed amount", {min = 0, max = 50, default = 5})
antiaim:Element("Slider", "torso x", {min = -25, max = 25, default = 0})
antiaim:Element("Slider", "torso y", {min = -25, max = 25, default = 1})
antiaim:Element("Slider", "torso z", {min = -25, max = 25, default = 0})
antiaim:Element("Slider", "leg x", {min = -25, max = 25, default = 0})
antiaim:Element("Slider", "leg y", {min = -25, max = 25, default = 1})
antiaim:Element("Slider", "leg z", {min = -25, max = 25, default = 0})
antiaim:Element("Toggle", "jitter")
antiaim:Element("Slider", "jitter offset", {min = -180, max = 180, default = 0})
antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "zero", "fake up", "fake down", "fake zero", "joe.tapped"}})
antiaim:Element("Slider", "spin speed", {min = 1, max = 420, default = 4})

local LagTick = 0
local fakelag = rage:Sector("fakelag", "Left")
...
fakelag:Element("Slider", "limit", {min = 1, max = 50, default = 5})
fakelag:Element("ToggleColor", "visualize lag", {default = {Toggle = false, Color = Color3.fromRGB(113,13,255)}}, function(tbl)
	if tbl.Toggle then
...
exploits:Element("Button", "god mode", {}, function() 
	game:GetService("ReplicatedStorage").Events.ApplyGun:FireServer({Model = ReplicatedStorage.Hostage.Hostage,Name = "USP"}, game.Players.LocalPlayer);
end)
exploits:Element("ToggleColor", "crimwalk", {default = {Color = COL3RGB(113,13,255)}}, function()
	if values.rage.exploits.crimwalk.Toggle and values.rage.exploits.crimwalk.Active then
		local crimwalkpart = Instance.new("Part")
		crimwalkpart.Position = LocalPlayer.Character.HumanoidRootPart.Velocity
		crimwalkpart.CanCollide = false
		crimwalkpart.CFrame = LocalPlayer.Character.HumanoidRootPart.CFrame
		crimwalkpart.Name = "Part"
		crimwalkpart.Size = Vector3.new(30, 1, 30)
		crimwalkpart.Parent = CrimwalkFolder
		crimwalkpart.Transparency = 1
		local Weld = Instance.new("Weld", crimwalkpart)
		Weld.Parent = crimwalkpart
		Weld.Part0 = crimwalkpart
		...
		for _,hitbox in next, LocalPlayer.Character:GetChildren() do      
			if hitbox:IsA("BasePart") and hitbox.Name ~= "HumanoidRootPart" then      
				...
				part.CanCollide = false      
				part.Material = Enum.Material.ForceField       
				part.Color = values.rage.exploits.crimwalk.Color      
				part.Name = "crimwalk"     
				part.Transparency = 0      
				part.Size = hitbox.Size      
				part.Parent = CrimwalkFolder      
			end      
		end
	else
		CrimwalkFolder:ClearAllChildren()
	end
end)
local clientoffset = rage:Sector("client offset", "Left") 
clientoffset:Element("Toggle", "enabled") 
clientoffset:Element("Toggle", "collision") 
clientoffset:Element("Toggle", "focus camera") 
clientoffset:Element("Toggle", "invert") 
clientoffset:Element("Dropdown", "offset method", {options = {"none","custom","wasd"}})
clientoffset:Element("Slider", "wasd offset", {min = 0, max = 25, default = 0})
clientoffset:Element("Slider", "offset x", {min = -25, max = 25, default = 0})
clientoffset:Element("Slider", "offset y", {min = -25, max = 25, default = 0})
clientoffset:Element("Slider", "offset z", {min = -25, max = 25, default = 0})



local players = visuals:Sector("players", "Left") 
players:Element("Toggle", "teammates") 
players:Element("ToggleColor", "box", {default = {Color = COL3RGB(113,13,255)}}) 
players:Element("ToggleColor", "name", {default = {Color = COL3RGB(113,13,255)}}) 
players:Element("Toggle", "health") 
players:Element("ToggleColor", "weapon", {default = {Color = COL3RGB(113,13,255)}}) 
players:Element("ToggleColor", "weapon icon", {default = {Color = COL3RGB(113,13,255)}}) 
...
effects:Element("ToggleTrans", "weapon chams", {default = {Color = COL3RGB(113,13,255), Transparency = 0}}, function(tbl) 
...
effects:Element("ToggleTrans", "accessory chams", {default = {Color = COL3RGB(113,13,255)}}, function(val) 
...
effects:Element("ToggleTrans", "arm chams", {default = {Color = COL3RGB(113,13,255)}}, function(val) 
...
effects:Element("ToggleColor", "world color", {default = {Color = COL3RGB(113,13,255)}}, function(val) 
	if val.Toggle then 
...
effects:Element("ToggleColor", "Ambient", {default = {Color = COL3RGB(113,13,255)}}, function(val) 
	if val.Toggle then
...
self:Element("Slider", "silent angle speed", {min = 6, max = 18, default = 12})
...
self:Element("ToggleColor", "self chams", {default = {Color = COL3RGB(113,13,255)}}, function(tbl) 
	if tbl.Toggle then 
		for _,obj in pairs(SelfObj) do 
			if obj.Parent ~= nil then 
				obj.Material = values.visuals.self["self material"].Dropdown == "Smooth" and "SmoothPlastic" or "ForceField" and "ForceField" or "Neon" and "Neon" or "Glass" and "Glass"
...
self:Element("Dropdown", "self material", {options = {"Smooth", "Neon", "ForceField", "Glass"}})
self:Element("Slider", "self reflectance", {min = 0, max = 100, default = 0})
...
world:Element("ToggleColor", "bullet tracers", {default = {Color = COL3RGB(113, 13, 255)}}) 
world:Element("ToggleColor", "impacts", {default = {Color = COL3RGB(113, 13, 255)}}) 
world:Element("ToggleColor", "hit chams", {default = {Color = COL3RGB(113, 13, 255)}}) 
...
client:Element("Toggle", "damage bypass")
client:Element("Toggle", "gun modifiers")
...
client:Element("Toggle", "shop modifiers") 
...
movement:Element("Slider", "walkspeed speed", {min = 16, max = 300, default = 16}) 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "Gid gud" or "Getting tapped by joe.tapped bozo", false, "Innocent", false, true) 
			wait(values.misc.chat["speed (ms)"].Slider/1000) 
			 
		end 
	end 
end) 
chat:Element("Dropdown", "type", {options = {"standard", "joe.tapped"}}) 
chat:Element("Slider", "speed (ms)", {min = 150, max = 1000, default = 500}) 
chat:Element("Toggle", "random kill say") 
chat:Element("Toggle", "kill say") 
chat:Element("TextBox", "message", {placeholder = "message"}) 
chat:Element("Toggle", "no filter") 

local killsaytable = {
	"Tapped By Joe.Tapped",
	"What Are You Doing Step Script?",
	"Gawd Damn Lord Have Mercy Yo Forehead So Shiny From All This Tapping On It",
	"No Joe.Tapped No Talkie Walkie",
	"Sheeesh Bro Got Tapped By Joe.Tapped Once Again?",
	"You Got Onetapped By A Cat",
	"Dam Joe.Tapped Update Kinda Fire",
	"Welcome To My New Video Today We Are Tapping Random NN's",
	"Suka Blyat",
	"Hah Monke",
	"Monke Squad Ontop Sit NN dog"
}
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	if current == 0 then return end      
	if values.misc.chat["random kill say"].Toggle then      
...
server:Element("Button", "rejoin server", {}, function()
...
local function YROTATION(cframe) 
	...
	return CF(cframe.Position) * CFrame.Angles(0,y,0) 
end 
local function XYROTATION(cframe) 
	local x, y, z = cframe:ToOrientation() 
	return CF(cframe.Position) * CFrame.Angles(x,y,0) 
end 
local weps = { 
...
RunService.RenderStepped:Connect(function(step) 
	...
	if PlayerIsAlive then 
		if values.rage["client offset"]["enabled"].Toggle and values.rage["client offset"]["enabled"].Active then
			if values.rage["client offset"]["focus camera"].Toggle and values.rage["client offset"]["focus camera"].Active then
				print("Running Client Offset Focus Camera")
				game:GetService("Workspace").CurrentCamera.CameraSubject = game:GetService("Players").LocalPlayer.Character:FindFirstChild("Head")
			else
				game:GetService("Workspace").CurrentCamera.CameraSubject = game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")
			end
			if values.rage["client offset"]["collision"].Toggle and values.rage["client offset"]["collision"].Active then
				print("Running Client Offset Collision")
			...
			if values.rage["client offset"]["offset method"].Dropdown == "custom" then
				print("Running Client Offset")
				if values.rage["client offset"]["invert"].Toggle and values.rage["client offset"]["invert"].Active then
					game:GetService("Players").LocalPlayer.Character.LowerTorso:FindFirstChildWhichIsA("Motor6D").C0 = CFrame.new(-values.rage["client offset"]["offset x"].Slider, -values.rage["client offset"]["offset y"].Slider, -values.rage["client offset"]["offset z"].Slider)
				else
					game:GetService("Players").LocalPlayer.Character.LowerTorso:FindFirstChildWhichIsA("Motor6D").C0 = CFrame.new(values.rage["client offset"]["offset x"].Slider, values.rage["client offset"]["offset y"].Slider, values.rage["client offset"]["offset z"].Slider)
				end
			end
		...
		if values.misc.client["gun modifiers"].Toggle then
		...
		if workspace:FindFirstChild("Map") and workspace.Map:FindFirstChild("SpawnPoints") and workspace.Map:FindFirstChild("Clips") and Client.gun ~= "none" and Client.gun.Name ~= "C4" and values.rage.aimbot.enabled.Toggle and (LocalPlayer.Character.Humanoid.WalkSpeed ~= 0) then  
			local Origin = values.rage.aimbot.origin.Dropdown == "real character" and LocalPlayer.Character.Head.Position and LocalPlayer.Character.UpperTorso.Position and LocalPlayer.Character.LowerTorso.Position and LocalPlayer.Character.LeftHand.Position and LocalPlayer.Character.LeftLowerArm.Position and LocalPlayer.Character.LeftUpperArm.Position and LocalPlayer.Character.RightHand.Position and LocalPlayer.Character.RightLowerArm.Position and LocalPlayer.Character.RightUpperArm.Position and LocalPlayer.Character.LeftFoot.Position and LocalPlayer.Character.LeftLowerLeg.Position and LocalPlayer.Character.LeftUpperLeg.Position and LocalPlayer.Character.RightFoot.Position and LocalPlayer.Character.RightLowerLeg.Position and LocalPlayer.Character.RightUpperLeg.Position or values.rage.aimbot.origin.Dropdown == "character" and LocalPlayer.Character.LowerTorso.Position + Vec3(0, 2.5, 0) or values.rage.aimbot.origin.Dropdown == "camera" and Camera.CFrame.p 
			for _,Player in pairs(Players:GetPlayers()) do 
				if Player.Character and Player.Character:FindFirstChild("Humanoid") and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and Player ~= LocalPlayer and values.rage.aimbot["resolver"].Toggle and Player.Character.UpperTorso:FindFirstChild("Waist") then 
					Player.Character.UpperTorso.Waist.C0 = CFrame.new(0, 0, 0) 
					Player.Character.LowerTorso.Root.C0 = CFrame.Angles(0, 0, 0) 
					Player.Character.RightUpperArm:FindFirstChildWhichIsA('Motor6D').C0 = CFrame.new(1.5 * (0.7), 0.549999952, -0.2)
					Player.Character.LeftUpperArm:FindFirstChildWhichIsA('Motor6D').C0 = CFrame.new(-(1.5 * (0.7)), 0.549999952, -0.2)
					Player.Character.Humanoid.MaxSlopeAngle = 0
					for _,Animation in pairs(Player.Character.Humanoid:GetPlayingAnimationTracks()) do
						Animation:Stop()
					end 
				end 
				if values.rage.aimbot["auto shoot"].Toggle and Player.Character and Player.Character:FindFirstChild("Humanoid") and not Client.DISABLED and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and not Player.Character:FindFirstChildOfClass("ForceField") and Player ~= LocalPlayer and Player.Team ~= LocalPlayer.Team and Player:FindFirstChild("Status") and Player.Status.Team.Value ~= LocalPlayer.Status.Team.Value and Player.Status.Alive.Value then
					local Ignore = {Camera, workspace.Ray_Ignore, workspace.Debris, workspace.Map.Clips, workspace.Map.SpawnPoints, LocalPlayer.Character, Player.Character:FindFirstChild("HumanoidRootPart")}
					...
					for _,Hitbox in ipairs(Hitboxes) do 
						...
						until EndHit ~= nil or #Hits >= 1 or Hit == nil 
						if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 1 then 
							if #Hits == 0 then
								local Damage = Client.gun.DMG.Value * Multipliers[EndHit.Name] 
								--[[
								if Player:FindFirstchild("Kevlar") and string.find(EndHit.Name, "Head") or Player:FindFirstchild("Kevlar") and string.find(EndHit.Name, "Head") and Player:FindFirstChild("Helmet") then
								...
								if Damage >= values.rage.aimbot["minimum damage"].Slider then 
									RageTarget = EndHit 
									Filter = true 
									Client.firebullet()
									Filter = false
								...
								local penetration = Client.gun.Penetration.Value * (0.01 * values.rage.aimbot["ragebot multiplier"].Slider)
								local limit = 0 
								local dmgmodifier = 1 
								for i = 1, #Hits do 
									local data = Hits[i] 
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then
			...
			function replacePT(part, weldName)
			...
			if values.rage.angles["special yaw base"].Dropdown == "custom" then      
                replacePT(LocalPlayer.Character.UpperTorso, "Waist")
                replacePT(LocalPlayer.Character.LowerTorso, "Root")
                ...
                LocalPlayer.Character.UpperTorso.CFrame = Root.CFrame * CFrame.new(values.rage.angles["torso x"].Slider, values.rage.angles["torso y"].Slider, math.fmod(values.rage.angles["torso z"].Slider, 9e9))
                LocalPlayer.Character.LowerTorso.CFrame = Root.CFrame * CFrame.new(values.rage.angles["leg x"].Slider, values.rage.angles["leg y"].Slider, math.fmod(values.rage.angles["leg z"].Slider), 9e9)
			elseif values.rage.angles["special yaw base"].Dropdown == "under" then
                replacePT(LocalPlayer.Character.UpperTorso, "Waist")
                replacePT(LocalPlayer.Character.LowerTorso, "Root")
                for _, v in pairs(LocalPlayer.Character:GetChildren()) do
                    if v:IsA("BasePart") then
			...
			elseif values.rage.angles["special yaw base"].Dropdown == "cursed" then
				local cursedamount = values.rage.angles["cursed amount"].Slider
				replacePT(LocalPlayer.Character.UpperTorso, "Waist")
				replacePT(LocalPlayer.Character.LowerTorso, "Root")
				for _, v in pairs(LocalPlayer.Character:GetChildren()) do
					if v:IsA("BasePart") then
				...
				LocalPlayer.Character.UpperTorso.CFrame = Root.CFrame * CFrame.new(math.random(-cursedamount, cursedamount), math.random(-cursedamount, cursedamount), math.random(-cursedamount, cursedamount))
				LocalPlayer.Character.LowerTorso.CFrame = Root.CFrame * CFrame.new(math.random(-cursedamount, cursedamount), math.random(-cursedamount, cursedamount), math.random(-cursedamount, cursedamount))
            end 
			Root.CFrame = YROTATION(CFramePos)
            local Pitch = values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "zero" and 0 or values.rage.angles["pitch"].Dropdown == "fake up" and CamLook.Z * 2.3 * math.sqrt(2.3) or values.rage.angles["pitch"].Dropdown == "fake down" and CamLook.Z * 2.3 * math.sqrt(-2.3) or values.rage.angles["pitch"].Dropdown == "fake zero" and CamLook.Z + 12 or values.rage.angles["pitch"].Dropdown == "joe.tapped" and math.floor * math.acos / CamLook.Y + math.floor - math.random(-90, 89) or 2.5
...
mt.__namecall = function(self, ...) 
	...
	if method == "FireServer" then 
		if string.len(self.Name) == 38 then 
			return 
		elseif self.Name == "FallDamage" or self.Name == "BURNME" and values.misc.client["damage bypass"] then 
			return 
	...
	if method == "FindPartOnRayWithWhitelist" and not checkcaller() and Client.gun ~= "none" and Client.gun.Name ~= "C4" then 
		if #args[2] == 1 and args[2][1].Name == "SpawnPoints" then 
			if values.misc.client["shop modifiers"].Toggle then 
				return LocalPlayer.Status.Team.Value == "T" and args[2][1].BuyArea or args[2][1].BuyArea2 
			end 
		end 
	end 
	...
	if method == "FireServer" and self.Name == "HitPart" then 
		...
		if values.rage.aimbot["prediction"].Toggle and RageTarget ~= nil then
			coroutine.wrap(function()
				...
				args[2] = args[2] + vel + dir *(Ping / Ping * 2) * hrp
				args[4] = 12
				args[12] = args[12] - dir + hrp - oldHrp
			end)()
		end
...
mt.__index = newcclosure(function(self, key)
	...
	if key == "Value" then
		if self.Name == "Auto" and values.misc.client["gun modifiers"].Toggle then
			return true
		elseif self.Name == "ReloadTime" or self.Name == "EquipTime" and values.misc.client["gun modifiers"].Toggle then
			return 0.001
		elseif self.Name == "BuyTime" and values.misc.client["shop modifiers"].Toggle then
			return 5
		end
	end
