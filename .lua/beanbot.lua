...
rage_knifebot:Toggle({name = "Enabled", flag = "kbot_enabled"}):Keybind()
...
rage_antiaim:Toggle({name = "Enabled", flag = "aa_enabled"}):Keybind()
...
misc_movement:Toggle({name = "Bunnyhop", flag = "m_bhop_enabled"}):Keybind()
misc_movement:Slider({name = "Bunnyhop speed", min = 15, max = 300, default = 60, ending = "studs/s", flag = "m_bhop_speed"})

misc_killall:Toggle({name = "Enabled", flag = "kall_enabled"}):Keybind()
...
exploits_autobuy:Toggle({name = "Enabled", flag = "abuy_enabled"}):Keybind()
