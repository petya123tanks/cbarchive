...
Title = "SaladWare Has Successfully Loaded!"; -- 
Text = "Update 4.0 Made By Hampe"; -- 
Duration = 6; -- 
})
...
antiaim:Element("Dropdown", "pitch", {options = {"up", "down", "imposter", "random", "salad", "Random AA", "God", "fucker"}}) 
...
RunService.RenderStepped:Connect(function(step) 
	...
	if PlayerIsAlive then 
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then 
			...
			local Pitch = values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "salad" and -6 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-10, 10)/10 or values.rage.angles["pitch"].Dropdown == "Random AA" and RANDOM(-1362, 2337)/5078 or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "fucker" and -13 or 2.5 or 2.5
