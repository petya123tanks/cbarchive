...
function library:New(name) 
	...
	cursor.ZIndex = 1000 
	cursor.ImageColor3 = COL3RGB(111, 222, 255) 
	...
	do 
		...
		TextLabel.BackgroundColor3 = COL3RGB(12, 12, 12)
		TextLabel.BackgroundTransparency = 0
		TextLabel.Position = UDIM2(0, 8, 0.4, 0) 
		TextLabel.Size = UDIM2(0, 140, 0, 20) 
		TextLabel.ZIndex = 2 
	...
	TabButtons.Position = UDIM2(0, 10, 0, 100)
	...
	function menu:Tab(text) 
		...
		TextButton.Size = UDIM2(1, 90, 0, 50)
		...
		TabGui.Name = "TabGui" 
		TabGui.Parent = Tabs 
		TabGui.BackgroundColor3 = COL3RGB(111, 222, 255) 
		...
		Left.Name = "Left" 
		Left.Parent = TabGui 
		Left.BackgroundColor3 = COL3RGB(111, 222, 255) 
		...
		Right.Name = "Right" 
		Right.Parent = TabGui 
		Right.BackgroundColor3 = COL3RGB(111, 222, 255) 
		...
		if first then 
			TextButton.TextColor3 = COL3RGB(111, 222, 255) 
			currenttab = text 
			TabGui.Visible = true 
			first = false 
		end 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			SectionText.BackgroundColor3 = COL3RGB(111, 222, 255) 
			...
			SectionText.TextColor3 = COL3RGB(111, 222, 255) 
			...
			sectiontabs.BackgroundColor3 = COL3RGB(111, 222, 255) 
			...
			function MSector:Tab(text) 
				...
				TextButton.BackgroundColor3 = COL3RGB(111, 222, 255) 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						TextLabel.BackgroundColor3 = COL3RGB(111, 222, 255) 
						...
						TextLabel.Font = Enum.Font.GothamSemibold 
						TextLabel.Text = "..." 
						TextLabel.TextColor3 = COL3RGB(111, 222, 255) 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = COL3RGB(111, 222, 255) 
							...
							do 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = COL3RGB(111, 222, 255) 
									else 
						...
						ImageLabel.BackgroundColor3 = COL3RGB(111, 222, 255) 
					...
					elseif type == "ToggleKeybind" then 
						...
						Toggle.Name = "Toggle" 
						Toggle.Parent = tab1 
						Toggle.BackgroundColor3 = COL3RGB(111, 222, 255) 
						Toggle.BackgroundTransparency = 1.000 
						Toggle.Size = UDIM2(1, 0, 0, 15) 

						Button.Name = "Button" 
						Button.Parent = Toggle 
						Button.BackgroundColor3 = COL3RGB(111, 222, 255) 
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(111, 222, 255)}) 
						...
						do 
							...
							Keybind.Size = UDIM2(0,txt:GetTextSize("None", 14, Enum.Font.GothamSemibold, Vec2(700, 12)).X + 5,0, 12) 
							...
							Always.Text = "Always" 
							Always.TextColor3 = COL3RGB(111, 222, 255) 
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.TextColor3 = COL3RGB(111, 222, 255) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
					...
					elseif type == "ToggleColor" then 
						tabsize = tabsize + UDIM2(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or COL3RGB(111, 222, 255)} 
						...
						Huedrag.BackgroundColor3 = COL3RGB(111, 222, 255) 
					...
					elseif type == "ToggleTrans" then 
						tabsize = tabsize + UDIM2(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or COL3RGB(111, 222, 255), Transparency = data.default and data.default.Transparency or 0} 
						...
						Transpick.BackgroundColor3 = COL3RGB(111, 222, 255) 
						...
						Transcolor.BackgroundColor3 = COL3RGB(111, 222, 255) 
						...
						Transdrag.BackgroundColor3 = COL3RGB(111, 222, 255) 
					...
					elseif type == "Dropdown" then 
						...
						Dropdown.Name = "Dropdown" 
						Dropdown.Parent = tab1 
						Dropdown.BackgroundColor3 = COL3RGB(111, 222, 255) 
						Dropdown.BackgroundTransparency = 1.000 
						Dropdown.Position = UDIM2(0, 0, 0.255102038, 0) 
						Dropdown.Size = UDIM2(1, 0, 0, 39) 
						...
						TextLabel_3.Parent = Dropdown 
						TextLabel_3.BackgroundColor3 = COL3RGB(111, 222, 255) 
						TextLabel_3.BackgroundTransparency = 1.000 
						TextLabel_3.Position = UDIM2(0, 32, 0, -1) 
						TextLabel_3.Size = UDIM2(0.111913361, 208, 0.382215232, 0) 
						TextLabel_3.Font = Enum.Font.GothamSemibold 
					...
					elseif type == "Slider" then 
						...
						Slider.Name = "Slider" 
						Slider.Parent = tab1 
						Slider.BackgroundColor3 = COL3RGB(111, 222, 255) 
						...
						Frame.Parent = Button 
						Frame.BackgroundColor3 = COL3RGB(111, 222, 255) 
						Frame.BorderSizePixel = 0 
						Frame.Size = UDIM2(0.5, 0, 1, 0) 

						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(111, 222, 255)), ColorSequenceKeypoint.new(1, COL3RGB(111, 222, 255))} 
						UIGradient.Rotation = 90 
						UIGradient.Parent = Frame 

						Value.Name = "Value" 
						Value.Parent = Slider 
						Value.BackgroundColor3 = COL3RGB(111, 222, 255) 
					...
					elseif type == "Button" then 
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Scroll.BackgroundColor3 = COL3RGB(111, 222, 255)      
							...
							Frame.ScrollBarImageColor3 = COL3RGB(111, 222, 255)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = COL3RGB(111, 222, 255)      
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(111, 222, 255)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
				...
				elseif type == "TextBox" then 
					...
					Box.Name = "Box" 
					Box.Parent = Inner 
					Box.BackgroundColor3 = COL3RGB(111, 222, 255) 
					...
					TextBox.TextColor3 = COL3RGB(111, 222, 255) 
...
local function ChangeCharacter(NewCharacter) 
	...
	if LocalPlayer.Character:FindFirstChildOfClass("Shirt") then 
		...
		if TBLFIND(values.misc.client.removals.Jumbobox, "clothes") then 
...
for _,lua in pairs(listfiles("nptlua")) do 
	local luaname = GSUB(lua, "nptlua\\", "") 
...
luascripts:Element("Button", "LOAD", {}, function() 
	loadstring(readfile("nptlua\\"..values.luas["lua scripts"].lua.Scroll))() 
end)
...
while true do
    ...
    if LocalPlayer.Character and LocalPlayer.Character.PrimaryPart then
        ...
        if math.floor(graphVelocity) == 300 then
            VelocityCounter.Color = COL3(1,0.3,0.1)
        end
        --]]
...
antiaim:Element("Slider", "yaw offset", {min = -300, max = 300, default = 0}) 
antiaim:Element("Toggle", "jitter") 
antiaim:Element("Slider", "jitter offset", {min = -300, max = 300, default = 0}) 
antiaim:Element("Dropdown", "pitch", {options = {"God", "Sus_down", "freak", "up", "down", "imposter", "glitch", "zero", "random", "brr", "Bodyarm", "negative", "wtf"}}) 
antiaim:Element("Toggle", "extend pitch") 
antiaim:Element("Dropdown", "body roll", {options = {"off", "180"}}) 
antiaim:Element("Slider", "spin speed", {min = 1, max = 300, default = 4})
...
exploits:Element("ToggleKeybind", "noclip",{},function(tbl)
	spawn(function()
		while values.rage.exploits["noclip"].Toggle and values.rage.exploits["noclip"].Active do
...
players:Element("ToggleColor", "box", {default = {Color = COL3RGB(111, 222, 255)}})
players:Element("ToggleTrans", "visible chams", {default = {Color = COL3RGB(111, 222, 255)}}, function(tbl)
...
players:Element("ToggleColor", "name", {default = {Color = COL3RGB(111, 222, 255)}}) 
players:Element("ToggleColor", "health", {default = {Color = COL3RGB(111, 222, 255)}})
players:Element("ToggleColor", "weapon", {default = {Color = COL3RGB(111, 222, 255)}}) 
players:Element("ToggleColor", "weapon icon", {default = {Color = COL3RGB(111, 222, 255)}}) 
...
effects:Element("ToggleTrans", "weapon chams", {default = {Color = COL3RGB(111, 222, 255), Transparency = 0}}, function(tbl) 
...
effects:Element("ToggleTrans", "glove chams", {default = {Color = COL3RGB(111, 222, 255)}}, function(val) 
...
effects:Element("Toggle", "sleeve chams", {default = {Color = COL3RGB(111, 222, 255)}}, function(val) 
	if RArm == nil or LArm == nil then return end 
	if val.Toggle then
		if RSleeve ~= nil then 
...
effects:Element("ToggleTrans", "arm chams", {default = {Color = COL3RGB(111, 222, 255)}}, function(val) 
...
effects:Element("ToggleColor", "hitmarker", {default = {Color = COL3RGB(255, 255, 255)}})
...
self:Element("ToggleColor", "self chams", {default = {Color = COL3RGB(111, 222, 255)}}, function(tbl) 
	if tbl.Toggle then 
		for _,obj in pairs(SelfObj) do 
			if obj.Parent ~= nil then 
				obj.Material = values.visuals.self["self chams material"].Dropdown 
...
world:Element("ToggleTrans", "molly radius", {default = {Color = COL3RGB(111, 222, 255)}}, function(tbl) 
...
world:Element("ToggleColor", "bullet tracers", {default = {Color = COL3RGB(111, 222, 255)}}) 
world:Element("ToggleColor", "impacts", {default = {Color = COL3RGB(111, 222, 255)}})
...
world:Element("ToggleColor", "world color", {default = {Color = COL3RGB(111, 222, 255)}}, function(val) 
	if val.Toggle then 
...
fakelag:Element("ToggleColor", "visualize lag", {default = {Toggle = false, Color = COL3RGB(111, 222, 255)}}, function(tbl) 
	if tbl.Toggle then 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "u got neptuned" or "neptunium.cc", false, "Innocent", false, true) 
			wait(values.misc.chat["speed (ms)"].Slider/1000) 
			 
		end 
	end 
end) 
chat:Element("Dropdown", "type", {options = {"standard", "neptunium.cc"}}) 
...
local item = misc:Sector("item", "Left")
item:Element("ToggleColor", "item esp", {default = {Color = COL3RGB(180, 255, 230)}}, function(tbl) 
	for i,weapon in pairs(workspace.Debris:GetChildren()) do 
		if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then 
			weapon.BillboardGui.ImageLabel.Visible = tbl.Toggle and TBLFIND(values.misc.item["types"].Jumbobox, "icon") and true or false 
		end 
	end 
end) 
item:Element("Jumbobox", "types", {options = {"icon"}}, function(tbl) 
	for i,weapon in pairs(workspace.Debris:GetChildren()) do 
		if weapon:IsA("BasePart") and Weapons:FindFirstChild(weapon.Name) then 
			weapon.BillboardGui.ImageLabel.Visible = values.misc.item["item esp"].Toggle and TBLFIND(tbl.Jumbobox, "icon") and true or false 
			weapon.BillboardGui.ImageLabel.ImageColor3 = values.misc.item["item esp"].Color 
		end 
	end 
end)

local annoy = misc:Sector("annoy", "Right") 
annoy:Element("ToggleKeybind", "spam grenades") 
coroutine.wrap(function() 
	while true do 
		wait(0.5) 
		if values.misc.annoy["spam grenades"].Toggle and values.misc.annoy["spam grenades"].Active then 
			local oh1 = game:GetService("ReplicatedStorage").Weapons[values.misc.annoy.grenade.Dropdown].Model 
			local oh3 = 25 
			local oh4 = 35 
			local oh6 = "" 
			local oh7 = "" 
...
annoy:Element("Dropdown", "grenade", {options = {"Flashbang", "Smoke Grenade", "Molotov", "HE Grenade", "Decoy Grenade"}})
annoy:Element("Button", "server crasher", {}, function()      
	while true do
        pcall(function()
            game:GetService("RunService").RenderStepped:Wait()
            for i = 1,100,1 do
...
workspace.Debris.ChildAdded:Connect(function(obj) 
	if obj:IsA("BasePart") and Weapons:FindFirstChild(obj.Name) then 
		...
		ImageLabel.ImageColor3 = values.misc.item["item esp"].Color 
		ImageLabel.Image = GetIcon.getWeaponOfKiller(obj.Name) 
		ImageLabel.ScaleType = Enum.ScaleType.Fit 
		ImageLabel.Visible = values.misc.item["item esp"].Toggle and TBLFIND(values.misc.item["types"].Jumbobox, "icon") and true or false 
...
RunService.RenderStepped:Connect(function(step) 
	...
	if PlayerIsAlive then 
		...
		if TBLFIND(values.misc.client.removals.Jumbobox, "scope lines") then 
		...
		if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then      
			if values.rage.ragebot.enabled.Toggle then      
				local Origin = values.rage.ragebot.origin.Dropdown == "character" and LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 1.4, 0) or CamCFrame.p
		...
		if UserInputService:IsKeyDown("Space") and values.rage.movement["bunny hop"].Toggle then 
			...
			BodyVelocity.Velocity = Vec3(rot.LookVector.X,0,rot.LookVector.Z) * (values.rage.movement["speed"].Slider * 2) 
			if add == 0 and values.rage.movement.direction.Dropdown == "directional" and not UserInputService:IsKeyDown("W") then 
				...
				if values.rage.movement.type.Dropdown == "cframe" then 
				    BodyVelocity:Destroy()
					Root.CFrame = Root.CFrame + Vec3(rot.LookVector.X,0,rot.LookVector.Z) * values.rage.movement["speed"].Slider/50 
				end 
			end 
		end
...
mt.__namecall = function(self, ...) 
	...
	if method == "FireServer" then 
		if LEN(self.Name) == 38 then 
			return 
		elseif self.Name == "FallDamage" and TBLFIND(values.misc.client["damage bypass"].Jumbobox, "fall") or values.rage.movement["jump bug"].Toggle and values.rage.movement["jump bug"].Active then 
			return 
	...
	if method == "FireServer" and self.Name == "HitPart" then 
		...
		if values.visuals.world["bullet tracers"].Toggle then 
			coroutine.wrap(function() 
				...
				beam.Size = Vec3(0.03, 0.03, (Camera.CFrame.Position - args[2]).Magnitude) 
...
Crosshairs.Scope:GetPropertyChangedSignal("Visible"):Connect(function(current) 
	if not TBLFIND(values.misc.client.removals.Jumbobox, "scope lines") then return end 
