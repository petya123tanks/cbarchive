-- LUCKYBLOX.NET IS A PASTE MADE BY 𝐻𝒶𝓂𝓅𝑒#0706 INSPIRED BY BOTLUCKY.COM/LUCKYCHARMS

getgenv().values = {}
local library = loadstring(game:HttpGet'https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua')()
library:CreateWatermark("LuckyBlox | Build: DEV | ".. game.Players.LocalPlayer.Name..'')
library.theme.accentcolor = Color3.fromRGB(255, 80, 80)
library.theme.accentcolor2 = Color3.fromRGB(255, 80, 80)
library.theme.topheight = 45
library.theme.TextColor = Color3.fromRGB(255,255,255)
...
function library:New(name)
	...
	function menu:Tab(text)
		...
		TextButton.TextColor3 = Color3.fromRGB(0, 230, 69)
			...
			if currenttab ~= text then
				for i,v in pairs(TabButtons:GetChildren()) do
					if v:IsA("TextButton") then
						library:Tween(v, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(0, 230, 69)})
					end
				end
		...
		function Tab:MSector(text, side)
			...
			Section.BackgroundColor3 = Color3.fromRGB(0, 230, 69)
			...
			function MSector:Tab(text)
				...
				function tab:Element(type, text, data, callback)
					...
					if type == "Jumbobox" then
						...
						Button.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						TextLabel.Font = Enum.Font.SourceSansSemibold
						TextLabel.Text = "..."
						TextLabel.TextColor3 = Color3.fromRGB(0, 230, 69)
						TextLabel.TextSize = 14.000
						TextLabel.TextXAlignment = Enum.TextXAlignment.Left
						...
						Drop.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						for i,v in ipairs(data.options) do
							do
								...
								Button.MouseLeave:Connect(function()
									if not table.find(Element.value.Jumbobox, v) then
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(0, 230, 69)})
									end
								end)
							...
							for i,v in pairs(Drop:GetChildren()) do
								if v.Name ~= "UIListLayout" then
									if table.find(val.Jumbobox, v.Name) then
										...
										v.TextLabel.TextColor3 = Color3.fromRGB(0, 230, 69)
									end
								end
							end
							updatetext()
						...
						TextLabel_3.TextColor3 = Color3.fromRGB(0, 230, 69)
					...
					elseif type == "ToggleKeybind" then
						...
						Color.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						do
							...
							Keybind.BorderColor3 = Color3.fromRGB(0, 230, 69)
							...
							Keybind.TextColor3 = Color3.fromRGB(0, 230, 69)
							...
							Frame.BorderColor3 = Color3.fromRGB(0, 230, 69)
							...
							Always.BorderColor3 = Color3.fromRGB(0, 230, 69)
							...
							Hold.BorderColor3 = Color3.fromRGB(0, 230, 69)
							...
							Hold.Text = "Hold"
							Hold.TextColor3 = Color3.fromRGB(0, 230, 69)
							...
							Toggle.BackgroundTransparency = 1.000
							Toggle.BorderColor3 = Color3.fromRGB(0, 230, 69)
							...
							Toggle.Text = "Toggle"
							Toggle.TextColor3 = Color3.fromRGB(0, 230, 69)
					...
					elseif type == "ToggleColor" then
						...
						ColorP.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						ColorP.Text = ""
						ColorP.TextColor3 = Color3.fromRGB(0, 230, 69)
						...
						Colorpick.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						ColorDrag.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						Huepick.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						Huedrag.BorderColor3 = Color3.fromRGB(0, 230, 69)
					...
					elseif type == "ToggleTrans" then
						...
						Transpick.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						Transdrag.BorderColor3 = Color3.fromRGB(0, 230, 69)
					...
					elseif type == "Slider" then
						...
						Value.Text = "50"
						Value.TextColor3 = Color3.fromRGB(0, 230, 69)
					...
					elseif type == "Button" then
						...
						Button_2.BorderColor3 = Color3.fromRGB(0, 230, 69)
						...
						Button_2.MouseButton1Down:Connect(function()
							...
							library:Tween(TextLabel, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(0, 230, 69)})
							callback()
						end)
						...
						Button_2.MouseLeave:Connect(function()
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(0, 230, 69)})
						end)
					end
		...
		function Tab:Sector(text, side)
			...
			Section.Parent = TabGui[side]
			Section.BackgroundColor3 = Color3.fromRGB(0, 230, 69)
			Section.BorderColor3 = Color3.fromRGB(0, 230, 69)
			Section.BorderSizePixel = 0
			...
			Inner.Parent = Section
			Inner.BackgroundColor3 = Color3.fromRGB(39, 39, 39)
			Inner.BorderColor3 = Color3.fromRGB(0, 230, 69)
			Inner.BorderSizePixel = 0
			Inner.Position = UDim2.new(0, 1, 0, 1)
			...
			function Sector:Element(type, text, data, callback)
							...
							for i,v in ipairs(joe2) do
								...
								Button.MouseButton1Down:Connect(function()
									...
									for i,v in pairs(Frame:GetChildren()) do
										if v:IsA("TextButton") then
											library:Tween(v.TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(0, 230, 69)})
										end
									end
							...
							if v:IsA("Frame") then
								...
								for _,bad in pairs(v.Frame:GetChildren()) do
									if bad:IsA("TextButton") then
										bad.TextLabel.TextColor3 = Color3.fromRGB(0, 230, 69)
				...
				elseif type == "TextBox" then
					...
					TextBox.BorderColor3 = Color3.fromRGB(0, 230, 69)
				...
				elseif type == "Button" then
					...
					Button_2.Name = "Button"
					Button_2.Parent = Button
					Button_2.BackgroundColor3 = Color3.fromRGB(47, 47, 47)																																																																															-- LUCKYBLOX.NET IS A PASTE MADE BY 𝐻𝒶𝓂𝓅𝑒#0706 INSPIRED BY BOTLUCKY.COM/LUCKYCHARMS
					Button_2.BorderColor3 = Color3.fromRGB(0, 230, 69)
					Button_2.Position = UDim2.new(0, 30, 0.5, -9)
					Button_2.Size = UDim2.new(0, 175, 0, 18)
					Button_2.AutoButtonColor = false
...
for _,lua in pairs(listfiles("luckylua")) do
	local luaname = string.gsub(lua, "luckylua\\", "")
	table.insert(allluas, luaname)
end

RunService.RenderStepped:Wait()

local gui = library:New("LuckyBlox")
...
client:Element("Toggle", "infinite cash", nil, function(tbl)
	if tbl.Toggle then
		LocalPlayer.Cash.Value = 9999999
	end
end)
...
chat:Element("Toggle", "chat spam", nil, function(tbl)
	if tbl.Toggle then
		while values.misc.chat["chat spam"].Toggle do
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "buy gay.solutions", false, "Innocent", false, true)
			wait(values.misc.chat["speed (ms)"].Slider/1000)
		end
	end
end)
chat:Element("Dropdown", "type", {options = {"standard", "gay"}})
...
RunService.RenderStepped:Connect(function(step)
	...
	if values.rage.exploits["kill all"].Toggle and values.rage.exploits["kill all"].Active then
	  ...
	  if values.rage.exploits["knife kill all"].Toggle and values.rage.exploits["knife kill all"].Active then
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)
	...
	if values.misc.chat["kill say"].Toggle then
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "looks like you don't have gay.solutions", false, "Innocent", false, true)
	end
end)
