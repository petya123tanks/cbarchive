...
local gui = library:New("windsense.xyz") 
...
luascripts:Element("Button", "Watermark", nil, function()
        ...
        TextLabel_3.Text = "dev : wind#6247"
...
antiaim:Element("Dropdown", "pitch", {options = {"Sus_down", "freak", "up", "real_down", "180", "down", "glitch", "random"}}) 
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "Tf2", "Tf2 pan", "M55solix", "Slap", "1", "Minecraft", "jojo", "vibe", "supersmash", "epic", "retro", "quek"}}) 
...
movement:Element("Slider", "speed", {min = 1, max = 400, default = 40}) 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Winning" and "Join the winning team. Join windsense!" or "$$$ I'm using windsense lol $$$", false, "Innocent", false, true) 
			wait(values.misc.chat["speed (ms)"].Slider/1000) 
			 
		end 
	end 
end) 
chat:Element("Dropdown", "type", {options = {"Winning", "windsense"}}) 
...
do 
	function add(plr) 
		local ImageLabel = INST("ImageLabel") 
		ImageLabel.BackgroundColor3 = COL3RGB(255, 0, 247) 
		ImageLabel.BackgroundTransparency = 1.050 
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current) 
	...
	if values.misc.chat["kill say"].Toggle then 
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "#Winning with windsense" and values.misc.chat["message"].Text or "Allah is the Man", false, "Innocent", false, true) 
	end 
end) 
