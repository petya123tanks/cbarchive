...
library:CreateWatermark("Entropy | DEV | ".. game.Players.LocalPlayer.Name..'')
...
function library:New(name) 
	...
	Endware.Name = "electric boogalo" 
	Endware.ResetOnSpawn = false 
	Endware.ZIndexBehavior = "Global" 
	Endware.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = Endware 
	...
	game:GetService("RunService").RenderStepped:connect(function() 
		cursor.Visible = Endware.Enabled 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			Endware.Enabled = not Endware.Enabled 
			library.uiopen = Endware.Enabled 
		end 
	end) 
	...
	do 
		...
		TextLabel.BorderColor3 = COL3RGB(255, 80, 80) 
	...
	function menu:Tab(text) 
		...
		function Tab:MSector(text, side) 
			...
			Section.BorderColor3 = COL3RGB(255, 80, 80) 
			...
			Inner.BorderColor3 = COL3RGB(255, 80, 80) 
			...
			function MSector:Tab(text) 
				...
				tab1.BorderColor3 = COL3RGB(255, 80, 80) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Button.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						Drop.BorderColor3 = COL3RGB(255, 80, 80) 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						do 
							...
							Keybind.BorderColor3 = COL3RGB(255, 80, 80) 
							...
							Frame.BackgroundColor3 = COL3RGB(10, 10, 10) 
							Frame.BorderColor3 = COL3RGB(255, 80, 80) 
							...
							Always.BorderColor3 = COL3RGB(255, 80, 80) 
							...
							Hold.BorderColor3 = COL3RGB(255, 80, 80) 
							...
							Toggle.BackgroundTransparency = 1.000 
							Toggle.BorderColor3 = COL3RGB(255, 80, 80) 
					...
					elseif type == "ToggleColor" then 
						...
						ColorP.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						Colorpick.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						ColorDrag.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						Huepick.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						Huedrag.BorderColor3 = COL3RGB(255, 80, 80) 
					...
					elseif type == "ToggleTrans" then 
						...
						Transpick.BorderColor3 = COL3RGB(255, 80, 80) 
						...
						Transcolor.BackgroundColor3 = COL3RGB(255, 80, 80) 
						...
						Transdrag.BackgroundColor3 = COL3RGB(255, 80, 80) 
						Transdrag.BorderColor3 = COL3RGB(255, 80, 80) 
					...
					elseif type == "Dropdown" then 
						...
						ImageLabel.Parent = Button 
						ImageLabel.BackgroundColor3 = COL3RGB(255, 80, 80) 
						ImageLabel.BackgroundTransparency = 1.000 
						ImageLabel.Position = UDIM2(0, 165, 0, 6) 
						ImageLabel.Size = UDIM2(0, 6, 0, 4) 
						ImageLabel.Image = "http://www.roblox.com/asset/?id=6724771531" 
						...
						TextLabel_3.Parent = Dropdown 
						TextLabel_3.BackgroundColor3 = COL3RGB(255, 80, 80) 
						TextLabel_3.BackgroundTransparency = 1.000 
						TextLabel_3.Position = UDIM2(0, 32, 0, -1) 
						TextLabel_3.Size = UDIM2(0.111913361, 208, 0.382215232, 0) 
						TextLabel_3.Font = Enum.Font.SourceSansSemibold 
					...
					elseif type == "Button" then 
						...
						Button_2.BorderColor3 = COL3RGB(255, 80, 80) 
		...
		function Tab:Sector(text, side) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				elseif type == "Scroll" then      
					...
					Scroll.Name = "Scroll"      
					Scroll.Parent = Inner      
					Scroll.BackgroundColor3 = COL3RGB(255, 80, 80)      
					Scroll.BackgroundTransparency = 1.000      
				...
				elseif type == "Jumbobox" then      
					...
					Dropdown.Name = "Dropdown"      
					Dropdown.Parent = Inner      
					Dropdown.BackgroundColor3 = COL3RGB(255, 80, 80)      
					Dropdown.BackgroundTransparency = 1.000      
					Dropdown.Position = UDIM2(0, 0, 0.255102038, 0)      
					Dropdown.Size = UDIM2(1, 0, 0, 39)      
				...
				elseif type == "TextBox" then 
					...
					TextBox.BorderColor3 = COL3RGB(255, 80, 80) 
...
for _,lua in pairs(listfiles("entlua")) do 
	local luaname = GSUB(lua, "entlua\\", "") 
	INSERT(allluas, luaname) 
end 

RunService.RenderStepped:Wait() 

local gui = library:New("Entropy") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("entlua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
