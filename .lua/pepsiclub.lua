...
----------------------------------------------------------------------------------------
if game.CoreGui:FindFirstChild("pepsi.club") then
    game.CoreGui["pepsi.club"]:Destroy()
end
...
aE:CreateToggle("Watermark", function(K)
    if K == true then
        ...
        Text.Text = "pepsi.club | 00:00:00  | Oct. 17, 2021"
        ...
        local function UQHM_fake_script() -- Text.LocalScript 
            ...
            while wait() do
                ...
                script.Parent.Text = "pepsi.club | " ..h.. ":" ..m.. ":" ..s.. " " ..mo.. " | " ..mon[mont][1].. " " ..d.. ", " ..y
            end
        end
