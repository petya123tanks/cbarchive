	...
	Title = "Swindler.dg"; -- 
	Text = "Thank you for Using Swindler.dg!"; -- 
	Duration = 7; -- 
	})
    ...
    library:CreateWatermark("Swindler.tech | Build: BETA")
	...
	local cfglocation = "Swindcfg/"      
	makefolder("Swindcfg")      

	--Made by GiftedXI#2898 and Coded by 𝐻𝒶𝓂𝓅𝑒#0706
	...
	local gui = library:New("Swindler.dg")      
	...
	chat:Element("Toggle", "chat spam", nil, function(tbl)      
		if tbl.Toggle then      
			while values.misc.chat["chat spam"].Toggle do      
				game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Winning	" and "Join the winning team! Swindler.dg!!" or values.misc.chat.type.Dropdown == "swindler.dg" and "$$$ Im Using Swindler.dg $$$" or values.misc.chat.type.Dropdown == "Discord" and "$$$ https://discord.gg/yNjpFzXD $$$" or values.misc.chat.type.Dropdown == "MOM" and "I FUCKED UR MOM I FUCKED UR MOM I FUCKED UR MOM" or values.misc.chat.type.Dropdown == "Semi" and "🐀 RATTED BY SEMI  🐀 ❌ DONT FUCK ❌ WITH 👾BLOXSENSE 👾👨‍🦲USERS👨‍🦲", false, "Innocent", false, true) 
				wait(values.misc.chat["speed (ms)"].Slider/1000)      
					
			end      
		end      
	end)      
	chat:Element("Dropdown", "type", {options = {"winning", "swindler.dg", "Discord", "MOM", "SEMI"}}) 
	...
	ChatScript.createNewMessage("Swindler.dg","Swindler.dg is Successfully 100% Loaded",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("Swindler.dg","Thank you for Using Swindler :D",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("Swindler.dg","Version 1.3.9",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("Swindler.dg","Credits to Rainy.solution, Mexican Hook, LunarSense, Neptunium.cc, For Giving me Permissions :D",MainUIColor,Color3.new(1,1,1),0.01,nil)