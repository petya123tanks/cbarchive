...
library:CreateWatermark("endware$$$ ! ver.1.04 ! ez ")
...
for _,lua in pairs(listfiles("endlua")) do 
	local luaname = GSUB(lua, "endlua\\", "") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("endlua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
