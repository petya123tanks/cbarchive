...
self:Element("Slider", "viewmodel x", {min = -360, max = 360}, function(val)
...
self:Element("Slider", "viewmodel y", {min = -360, max = 360}, function(val)
    ViewmodelOffset = CFrame.new(values.visuals.self["viewmodel x"].Slider/100, values.visuals.self["viewmodel y"].Slider/100, values.visuals.self["viewmodel z"].Slider/100) * CFrame.Angles(0, 0, values.visuals.self.roll.Slider/180)
end)
self:Element("Slider", "viewmodel z", {min = -360, max = 360}, function(val)
    ViewmodelOffset = CFrame.new(values.visuals.self["viewmodel x"].Slider/100, values.visuals.self["viewmodel y"].Slider/100, values.visuals.self["viewmodel z"].Slider/100) * CFrame.Angles(0, 0, values.visuals.self.roll.Slider/180)
end)
self:Element("Slider", "roll", {min = -360, max = 360}, function(val)
    ViewmodelOffset = CFrame.new(values.visuals.self["viewmodel x"].Slider/100, values.visuals.self["viewmodel y"].Slider/100, values.visuals.self["viewmodel z"].Slider/100) * CFrame.Angles(0, 0, values.visuals.self.roll.Slider/180)
end)
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "elevator", "elevator2", "moan1", "moan2", "moan3", "moan4"}}) 
...
noclip:Element("ToggleKeybind", "noclip",{},function(tbl)
    ...
    noclip:Element("ToggleKeybind", "freezeclip", {}, function(tbl)
        if tbl.Toggle and tbl.Active then
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(60, 79, 255)), ColorSequenceKeypoint.new(0.12, Color3.fromRGB(131, 202, 255)), ColorSequenceKeypoint.new(0.72, Color3.fromRGB(131, 202, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(131, 202, 255))}
UIGradient.Rotation = 90
...
TextLabel_3.Text = "December 3 2021"
...
UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80, 80, 80)), ColorSequenceKeypoint.new(0.37, Color3.fromRGB(45, 45, 45)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(45, 45, 45))}
...
RunService.RenderStepped:Connect(function(step) 
				...
				for _,Player in pairs(Players:GetPlayers()) do 
					if TBLFIND(values.misc.client["gun modifiers"].Jumbobox, "firerate") then 
						...
						if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "front track") then 
							Player.Character.Head.Neck.C0 = CFrame.new(-3,2,-3) * CFAngles(0, 0, 0) 
						end 
	...
	local Pitch = values.rage.angles["pitch"].Dropdown == "none" and CamLook.Y or values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "zero" and 0 or values.rage.angles["pitch"].Dropdown == "imposter" and math.huge -5/0 -1 or values.rage.angles["pitch"].Dropdown == "random" and math.random(-10, 10)/10 or 2.5
