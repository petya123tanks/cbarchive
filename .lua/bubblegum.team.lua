-- bubblegum.team > cipsex > seexre > cutwar
...
local L_119_ = {
	Standard = {
		"bubblegum.team - makes you god! bubblegum.team - taps you! bubblegum.team - best for bests! bubblegum.team - makes you better! bubblegum.team - makes you catboy (real)! bubblegum.team - minecraft hud and best visuals! bubblegum.team - made with farm engine! bubblegum.team - bg.team (bubblegum.team) > cipex > seere > cw!",
		"go buy bubblegum.team.solutions", -- revival
		"$$$",
...
L_28_.RenderStepped:Connect(function(L_1691_arg0)
	...
	if library_flags["Watermark"] then
		...
		L_116_.Text = "bubblegum.team | " .. L_1759_ .. ":" .. L_1758_ .. ":" .. L_1757_ .. " | " .. L_32_.Name;
...
local L_5_ = {
	...
	draggable = true,
	flags = {},
	title = "bubblegum.team | best for bests",
	open = false,
	mousestate = inputService.MouseIconEnabled,
	popup = nil,
	instances = {},
...
L_28_.RenderStepped:Connect(function(L_1699_arg0)
	...
	if library_flags["Watermark"] then
		...
		L_116_.Text = " bubblegum.team | " .. L_1767_ .. ":" .. L_1766_ .. ":" .. L_1765_ .. " | " .. L_32_.Name;
		if L_116_.TextBounds.X > 210 then
			L_116_.TextSize = L_116_.TextSize - 1
		end
	end;
