...
local gui = library:New("Niggaware")
...
CreateHitElement("i fuck ur mom ",Color3.new(1,1,1), 5, 0, 270,  0, 22)
CreateHitElement("Press Delete to open and close the menu!",Color3.new(1,1,1), 3, 0, 280, 0, 22)