...
for _,lua in pairs(listfiles("onelua")) do      
	local luaname = GSUB(lua, "onelua\\", "")      
	INSERT(allluas, luaname)      
end      

RunService.RenderStepped:Wait()      

local gui = library:New("OneHook")      
...
luascripts:Element("Button", "load", {}, function()      
	loadstring(readfile("onelua\\"..values.luas["lua scripts"].lua.Scroll))()      
end)      
...
chat:Element("Toggle", "chat spam", nil, function(tbl)      
	if tbl.Toggle then      
		while values.misc.chat["chat spam"].Toggle do      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! onehook! ", false, "Innocent", false, true)      
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "everything here is pasted and detected !! tapped by onehook", false, "Innocent", false, true)      
	end      
end)      
