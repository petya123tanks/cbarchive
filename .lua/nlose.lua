if not getgenv().library then
    getgenv().library = loadstring(game:HttpGet("https://pastebin.com/raw/7iNsercj"))()
end
    ...
    [3] = {
        ...
        [6] = {
            ...
            [10] = {
                ...
                "Sound",
                p,
                {options = {"Skeet", "Minecraft", "Neverlose", "HitMarker", "Custom"}},
                "Hitsound_Sound"
            },
    ...
    [5] = {
        ...
        [1] = {
            ...
            [2] = {"Button", "Save Config", function()
                    game:GetService("nlose").ConfigEvent:Fire(
                        "SaveConfig",
...
y.initiate = function()
    ...
    local V = {
        ...
        Neverlose = "rbxassetid://6607113255",
